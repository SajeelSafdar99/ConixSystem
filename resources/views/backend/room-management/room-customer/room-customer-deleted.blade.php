...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('customer_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
          ...
          //   },
            ...
            @else
             @can('Restore Event Customer')
            {data: 'restoreeventsbutton', name: 'restoreeventsbutton', orderable:false},
            @endcan
            @endif      
        ]
    });
