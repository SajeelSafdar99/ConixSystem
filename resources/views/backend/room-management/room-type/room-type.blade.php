...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Room Types</h6>
           <div class="hidden-print" style="text-align: right; margin-top: -39px;">
           @can('Add Room Type')
          <a href="{{ url('room-management/room-type/room-type-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Room Type" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Room Types')
          <a href="{{ url('room-management/room-type/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Room Types List</a></li>
</ul>
