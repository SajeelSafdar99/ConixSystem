...
@endif
  ...
  <div class="row">
               <div class="col-sm-5">
                ...
                <br>
               <h6 class="box-title headingsettings"><b>RECEIPT DETAILS</b></h6>
                <br>

<div class="row mg-t-10">

        <label class="col-sm-3 form-control-label">  Receipt Number:  <span class="tx-danger">  * </span>  </label>
...
<div class="row mg-t-10">
        ...
        <label class="col-sm-3 form-control-label">  Receipt Date:  <span class="tx-danger">  * </span>  </label>
         <?php
...
?>
   <div class="col-sm-9 mg-t-10 mg-sm-t-0">
    <input @if ($errors->has('invoice_date')) style="border-color:red;" @endif type="text" name="invoice_date" id="invoice_date" class="form-control input-height" autocomplete="off" value="@if($init==0)<?php echo $today;?>@else{{old('invoice_date',$payment_update->invoice_date)}}@endif" readonly style="background-color: #c1c1c1"></div>
  </div>

   <br>
               <h6 class="box-title headingsettings"><b>PAYER INFORMATION</b></h6>
                <br>

<div class="row mg-t-10">
                  <label class="col-sm-3 form-control-label">Receipt Type:<span class="tx-danger">
                                *
                            </span>
                                                    </label>
...
<div class="col-sm-9 mg-t-10 mg-sm-t-0">
 <input @if($errors->has('guest_name')) style="border-color:red;" @endif type="text" class="form-control input-height" id="guest_name" name="guest_name" onkeyup="customerdata(this.value)" autocomplete="off" class="typeahead" placeholder="Search By Name or ID" value="@if($init==0){{old('guest_name')}}@else{{old('guest_name',$payment_update->guest_name)}}@endif">
...
<input @if ($errors->has('mem_code')) style="border-color:red;" @endif type="text" class="form-control input-height" id="mem_number" autocomplete="off" readonly style="background-color: #c1c1c1" value="@if($init==0){{old('mem_code')}}@else{{old($payment_update->member?$payment_update->member->mem_no:'')}}@endif"><input type="hidden" value="@if($init==0){{old('mem_number')}}@else{{$payment_update->mem_number}}@endif" name="mem_number" id="member_id">
 ...
 <label class="col-sm-1 form-control-label">
            ...
            <div class="col-sm-4 mg-t-10 mg-sm-t-0">
    <input @if ($errors->has('customer_id')) style="border-color:red;" @endif type="text" class="form-control input-height" id="customer_id" name="customer_id" autocomplete="off" readonly style="background-color: #c1c1c1" value="@if($init==0){{old('customer_id')}}@else{{old('customer_id',$payment_update->customer_id)}}@endif">
  </div>
</div>
    <div class="row mg-t-10">
      <label class="col-sm-3 form-control-label">
...
<a class="showAfterSelection" style="display: none" data-href="{{ url('finance-and-management/finance-ledger-accounts') }}" href="{{ url('finance-and-management/finance-ledger-accounts') }}" target="_blank">
...
<div class="row">
 <label class="col-sm-3 form-control-label">
         Payment Received For:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Payment Details:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
<label class="col-sm-3 form-control-label" style="color: black;">Payment Mode:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
...
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         ...
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
<input @if ($errors->has('surcharge')) style="border-color:red;" @endif type="number" id="surcharge" name="surcharge" autocomplete="off" oninput="add_surcharge()" class="form-control input-height" value="@if($init==0){{old('surcharge')}}@else{{old('surcharge',$payment_update->surcharge)}}@endif">
</div>
</div>
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
