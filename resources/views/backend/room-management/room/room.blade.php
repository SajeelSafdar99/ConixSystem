...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Rooms')
          <a href="{{ url('room-management/room/room-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Room" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Rooms')
          <a href="{{ url('room-management/room/deleted') }}">
        ...
        columns: [   
          ...
          //   },
            ...
            {data: 'room_no', name: 'room_no', searchable: true},
             {data: 'room_type', name: 'room_type', searchable: true},
