...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Room Rate Categories')
          <a href="{{ url('room-management/room-category/room-category-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Room Category" height="28" width="28" border="0/">
          </a>
          @endcan
         @can('View Deleted Room Rate Categories')
          <a href="{{ url('room-management/room-category/deleted') }}">
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Room Rate Categories List</a></li>
</ul>         
      @if($errors->any())
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Status</th>
                   @can('Edit Room Rate Categories')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Room Rate Categories')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('roomcategory.datatable') }}',
          'type': 'POST',
          'headers': {
