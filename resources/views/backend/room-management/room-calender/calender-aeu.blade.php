...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Booking Details</h6>
...
<ul class="breadcrumbee mg-b-25 mg-lg-b-50 border-bottom-custom">
  ...
  <li><a href="{{ url('room-management/calender') }}">Room Calendar</a></li>
             ...
             <div class="form-layout form-layout-4 ">
                <div class="desktop-screen-design">
                    <div  class="row ">
                        ...
                        <label class="col-sm-4 form-control-label {{ $errors->has('booking_no') ? ' has-error' : '' }}">
                          Booking Number:
...
?>
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input @if ($errors->has('booking_date')) style="border-color:red;" @endif id="booking_date"  class="form-control input-height" type="text" value="{{$roombooking->booking_date}}" name="booking_date" readonly style="background-color: #c1c1c1">
                    ...
                    <!-- row -->
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                   <input @if ($errors->has('check_in_date')) style="border-color:red;" @endif id="check_in_date"  class="form-control input-height" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" type="Date" value="{{$roombooking->check_in_date}}" name="check_in_date" readonly style="background-color: #c1c1c1">
             ...
             <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0"><textarea @if($errors->has('arrival_details')) style="border-color:red;"@endif id="arrival_details" class="form-control" readonly style="background-color: #c1c1c1" placeholder="Give any details" rows="2" type="text" name="arrival_details">{{$roombooking->arrival_details}}</textarea>
                  ...
                  Check-Out Date:
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input @if ($errors->has('check_out_date')) style="border-color:red;"@endif id="check_out_date"  class="form-control input-height" pattern="(?:19|20)[0-9]{2}-(?:(?:0[1-9]|1[0-2])-(?:0[1-9]|1[0-9]|2[0-9])|(?:(?!02)(?:0[1-9]|1[0-2])-(?:30))|(?:(?:0[13578]|1[02])-31))" type="Date"value="{{$roombooking->check_out_date}}" name="check_out_date" readonly style="background-color: #c1c1c1">
                   ...
                   <!--   <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input @if ($errors->has('check_out_time')) style="border-color:red;" @endif id="check_out_time" class="form-control input-height" type="time" name="check_out_time">
                  ...
                  <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0"><textarea @if($errors->has('departure_details')) style="border-color:red;"@endif id="departure_details" class="form-control" readonly style="background-color: #c1c1c1" placeholder="Give any details" rows="2" type="text" name="departure_details">{{$roombooking->departure_details}}</textarea>
                           
                        </div>
                    </div>
                   
                 </br></br>
               <h6 class="box-title" style="color: black;">GUEST INFORMATION</h6>
                 </br>
                  <div class="row mg-t-10">
                        <label class="col-sm-4 form-control-label">
                              Guest First Name:
              ...
              <div class="row mg-t-10">
                  ...
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                    <input @if($errors->has('guest_email')) style="border-color:red;"@endif id="guest_email" type="text" name="guest_email" readonly style="background-color: #c1c1c1" class="form-control input-height"value="{{$roombooking->guest_email}}" placeholder="Enter Email Id">
                     ...
                     <div class="row mg-t-10">
                  <label class="col-sm-4 form-control-label">  CNIC / Passport No.: <span class="tx-danger">*</span></label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                 ...
                 Relationship:
                    ...
                    <div class="row mg-t-10">
                  <label class="col-sm-4 form-control-label">  CNIC / Passport No.: </label>
                  <div class="col-sm-8 mg-t-10 mg-sm-t-0">
               ...
               <h6 class="box-title" style="color: black;">BOOKING REFERENCE</h6>
                 </br>
                  <div class="row mg-t-10">
                        <label class="col-sm-4 form-control-label">
                  Booked By:
                  <span class="tx-danger">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input @if ($errors->has('booked_by')) style="border-color:red;" @endif id="booked_by" class="form-control input-height" placeholder="Enter Name" readonly style="background-color: #c1c1c1" value="{{$roombooking->booked_by}}"  type="text" name="booked_by">
                           
                        </div>
                    </div>
                   
                     <div class="row mg-t-10">
               <label class="col-sm-4 form-control-label">Booking Type:<span class="tx-danger">
                                *
                            </span>
                          </label>
              <div class="col-sm-3 mg-t-10 mg-sm-t-0">
              <label class="rdiobox">
            <input type="radio" name="booking_type" disabled><span class="pabs">Member</span>
              </label>
            </div><!-- col-3 -->
            
              <div class="col-sm-3 mg-t-10 mg-sm-t-0">
              <label class="rdiobox">
                <input type="radio" name="booking_type" checked><span class="pabs">Customer</span>
              </label>
            </div><!-- col-3 -->
        </div><!-- row-->
          <div class="row mg-t-10">
                        <label class="col-sm-4 form-control-label">
                  Membership No. / Customer Name:
                  <span class="tx-danger">
                                *
                            </span>
                        </label>
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input @if($errors->has('moc_name')) style="border-color:red;"@endif id="moc_name" readonly style="background-color: #c1c1c1" class="form-control input-height typeahead" placeholder="Enter Number to Search" value="{{$roombooking->moc_name}}" type="text" name="moc_name" onkeyup="customerdata(this.value)">
  ...
  <ul id="areabox" class="areabox" style="color: #fff;background: aliceblue;
    list-style-type: none;color: black;"></ul>
                  ...
                  <!--  <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input id="moc_name" class="form-control input-height" type="text" readonly style="background-color: #c1c1c1" name="moc_name">
               ...
               <span class="tx-danger">
                 ...
                 <span class="tx-danger">
                  ...
                  <span class="tx-danger">
                     ...
                     <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <select @if ($errors->has('room')) style="border-color:red;" @endif onchange="chargesselect()" id="roomid" class="form-control input-height select2" name="room" readonly style="background-color: #c1c1c1">
                         <option label="Select a Room">
                                </option>
                                  @php $a=0; @endphp
                     @foreach($room as $rooms)
                   
                                 <option @if($roombooking->room==$rooms->id)  selected @endif  value="{{ $rooms->id }}">{{ $rooms->room_no }} (@if($roomtype[$a]['roomtypes']){{$roomtype[$a]['roomtypes']->desc}} @else @endif)
                                </option>
                 ...
                 <input id="roomtype{{ $rooms->id }}" type="hidden" name="room_typeid{{ $rooms->id }}" value="@if($roomtype[$b]['roomtypes']) {{$roomtype[$b]['roomtypes']->id}} @else @endif"> 
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <select @if ($errors->has('category')) style="border-color:red;" @endif onchange="chargesselect()" id="roomcategoryid" class="form-control input-height select2" name="category" readonly style="background-color: #c1c1c1">
                            <option label="Choose Category">
                                </option>
                               @foreach($room_category as $roomcategory)
                               
                                 <option @if($roombooking->category==$roomcategory->id)  selected @endif  value="{{ $roomcategory->id }}">
                                  {{ $roomcategory->desc }}
                                </option>     
                                @endforeach
                            </select>
               ...
               <h6 class="box-title" style="color: black;">EXTRA CHARGES</h6>
                 </br>
                 <table align="center" border="0" width="100%">
                  ...
                  <tbody>
                    ...
                    @foreach($bookingsubdata as $bookingsub)
                     <tr>
                       <td><select  id="{{ $bookingsub->id }}" onchange="extrachargesselect(this.id)" class="form-control input-height select2" name="charges_type[]" readonly style="background-color: #c1c1c1">
                    <option label="Select a Charges Type"></option>
                     @foreach($room_charges_type as $roomcharges)

                 
                                <option @if($bookingsub->charges_type_id==$roomcharges->id)  selected @endif value="{{ $roomcharges->id }}">
                                    {{ $roomcharges->type }}
                                 </option>
                   ...
                   <td>
            <input id="bill_details{{ $bookingsub->id }}" class="form-control input-height" type="text" name="bill_details[]" value="{{$bookingsub->bill_details}}" readonly style="background-color: #c1c1c1">
                  </td>
                  <td>
                      <input  id="charges_amount{{ $bookingsub->id }}" onkeyup="extrachargesselect2()"  class="form-control input-height charamt" type="number" name="charges_amount[]" value="{{$bookingsub->charges_amount}}" readonly style="background-color: #c1c1c1">
                  </td>
                   <td>
            ...
            <br/>
             <div class="row mg-t-10">
               ...
               <h6 class="box-title" style="color: black;">TOTAL</h6>
                 </br>
                  <div class="row mg-t-10">
                        <label class="col-sm-4 form-control-label">
                  Total Charges:
               ...
               <div class="row mg-t-10">
                   ...
                   Discount Amount:
                        ...
                        <div class="col-sm-4 mg-t-5 mg-sm-t-0">
                            <input type="number" @if($errors->has('discount_amount')) style="border-color:red;"@endif id="discount_amount" class="form-control input-height" placeholder="Enter Discount (if given)" value="{{$roombooking->discount_amount}}"  type="text" name="discount_amount" readonly style="background-color: #c1c1c1" oninput="calculate_total()">
...
<textarea @if ($errors->has('discount_details')) style="border-color:red;" @endif id="discount_details" readonly style="background-color: #c1c1c1" class="form-control" placeholder="Give any details" rows="2" type="text" name="discount_details">{{$roombooking->discount_details}}</textarea>
                  ...
                  <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <select @if ($errors->has('payment_mode')) style="border-color:red;" @endif class="form-control input-height select2" name="payment_mode" value="{{$roombooking->payment_mode}}" readonly style="background-color: #c1c1c1">

                                <option @if($roombooking->payment_mode=='Cash') selected @endif value="Cash">
                                    Cash
                                </option>
                                <option @if($roombooking->payment_mode=='Credit Card') selected @endif value="Credit Card">
                                    Credit Card
                                </option>
                                <option @if( $roombooking->payment_mode=='Cheaque') selected @endif value="Cheaque">
                                    Cheaque
                                </option>
                                <option @if($roombooking->payment_mode=='Other') selected @endif value="Other">
                                    Other
                                </option>
...
<!-- 
                    <div class="row mg-t-10">
                      ...
                      Amount Paid:
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input type="number" @if ($errors->has('amount_paid')) style="border-color:red;" @endif id="amount_paid" class="form-control input-height" placeholder="Enter Total paid Amount" name="amount_paid" oninput="calculate_total()">
                 ...
                 Balance:
                     <span class="tx-danger">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                            <input type="number" @if ($errors->has('grand_balance')) style="border-color:red;" @endif id="grand_balance" class="form-control input-height" value="{{$roombooking->total_balance}}" readonly style="background-color: #c1c1c1" name="grand_balance" oninput="calculate_total()">
                   ...
                   -->
                       <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
<textarea @if($errors->has('additional_notes'))style="border-color:red;"@endif id="additional_notes" class="form-control" placeholder="Give any details" rows="2" type="text" readonly style="background-color: #c1c1c1" name="additional_notes">{{$roombooking->additional_notes}}</textarea>
...
<script type="text/javascript">
 ...
 function addmorefields(){
  ...
  html=`<tr>
    <td><select id="${i}" onchange="extrachargesselect(this.id)" class="form-control input-height select2" name="charges_type[]" readonly style="background-color: #c1c1c1">
                    <option label="Select a Charges Type"></option>
                     @foreach($room_charges_type as $roomcharges)
                  ...
                  <td>
                      <input id="bill_details${i}" readonly style="background-color: #c1c1c1" class="form-control input-height" type="text" name="bill_details[]" >
                  </td>
                  <td>
                      <input id="charges_amount${i}" readonly style="background-color: #c1c1c1" onkeyup="extrachargesselect2()" class="form-control input-height charamt" type="number" name="charges_amount[]">
                  </td>
 <td>
