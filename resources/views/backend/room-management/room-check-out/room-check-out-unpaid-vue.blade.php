...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Room Check Out (Un-Paid)</h6>
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Rooms Unpaid Check Out List</a></li>
</ul>
...
<div id="app">
         ...
         <checkoutunpaiddt></checkoutunpaiddt>
