...
<br>
               <h6 class="box-title headingsettings"><b>GUEST BILL TO</b></h6>
                <br>
 <div class="row mg-t-10">
               <label class="col-sm-3 form-control-label">Booking Type:<span class="tx-danger">
                                *
                            </span>
                          </label>
    ...
    <input @if($roombooking->booking_type==0) checked="" @else disabled @endif type="radio" name="booking_type" value="0" ><span class="pabs">Member</span>
              ...
              <div class="col-sm-3 mg-t-10 mg-sm-t-0">
              <label class="rdiobox">
    <input @if($roombooking->booking_type==1) checked="" @else disabled @endif type="radio" name="booking_type" value="1"><span class="pabs">Guest</span>
              </label>
            </div><!-- col-3 -->
        </div><!-- row-->
         <div class="row mg-t-10">
    ...
    list-style-type: none;color: black;"></ul>
                    ...
                    <div class="row mg-t-10">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                           ...
                           <input type="button" value="Add New Customer" class="btn btn-info">
                           </a>
                        </div>
                    </div>
                      <div class="row mg-t-10">
...
<div class="row mg-t-10">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <select @if ($errors->has('room')) style="border-color:red;" @endif onchange="chargesselect()" id="roomid" class="form-control input-height select2" name="room" style="background-color: #c1c1c1">
                 ...
                 <input id="roomtype{{ $rooms->id }}" type="hidden" name="room_typeid{{ $rooms->id }}" value="@if($roomtype[$b]['roomtypes']) {{$roomtype[$b]['roomtypes']->id}} @else @endif">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <select @if ($errors->has('category')) style="border-color:red;" @endif onchange="chargesselect()" id="roomcategoryid" class="form-control input-height select2" name="category" style="background-color: #c1c1c1">
 ...
 <br/>
             <div class="row mg-t-10">
                  ...
                  Food Bill Charges:
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="number" @if($errors->has('food_bill_charges')) style="border-color:red;"@endif id="food_bill_charges" class="form-control input-height" readonly style="background-color: #c1c1c1" value="0"  type="text" name="food_bill_charges" >
                 ...
                 <table align="center" border="0" width="100%">
                  ...
                  <tbody>
                    ...
                    @foreach($bookingsubdata as $bookingsub)
                     <tr>
                       <td><select  id="{{ $bookingsub->id }}" onchange="extrachargesselect(this.id)" class="form-control input-height select2" name="charges_type[]">
