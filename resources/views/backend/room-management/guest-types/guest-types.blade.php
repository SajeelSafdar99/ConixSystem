...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Guest Types')
          <a href="{{ url('room-management/guest-types/guest-types-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Guest Type" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Guest Types')
          <a href="{{ url('room-management/guest-types/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Guest Types List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Guest Types')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Guest Types')
