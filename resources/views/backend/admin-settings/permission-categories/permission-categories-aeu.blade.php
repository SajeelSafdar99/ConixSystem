...
<ul class="breadcrumbee mg-b-25   border-bottom-custom">
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href="{{ url('admin-settings/permission-categories') }}">Permission Categories List</a></li>
...
@endif
    ...
    @if($init==1)
    <form method="post" action="{{ url('admin-settings/permission-categories/update') }}/{{ $permission_category_update->id }}">
     @else
    <form method="post">
    @endif     
    @csrf   
   ...
   <input name="desc" type="text" class="form-control input-height" placeholder="Enter Category / Module Name" value="@if($init==0){{old('desc')}}@else{{$permission_category_update->desc}}@endif">
                  </div>
                </div>
...
<div class="row mg-t-10">
                ...
                <div class="form-layout-footer mg-t-30">
                  ...
                  &nbsp&nbsp
                  <a href="{{ url('admin-settings/permission-categories') }}" class="btn btn-secondary">Cancel</a>
