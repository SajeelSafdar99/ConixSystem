...
<div class="br-pagebody">
        <div>
         ...
         <div style="text-align: right; margin-top: -39px;">
          <a href="{{ url('admin-settings/permissions/permissions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Permission" height="28" width="28" border="0/">
          </a>
          <a href>
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Permissions List</a></li>
</ul>
