...
<a href="{{ url('admin-settings/profile/profile-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add Company Profile" height="28" width="28" border="0/">
          </a>
       <!--    @if($records<1) -->
...
// $(document).ready(function() {
        ...
        columns: [   
          ...
          //   },
            ...
            @can('Edit Company Profile')
            {data: 'button', name: 'button', orderable: false},  
            @endcan        
        ]
    });
