...
<div class="br-pagebody">
        <div>
         ...
         <div style="text-align: right; margin-top: -39px;">
          @can('Add Roles')
          <a href="{{ url('admin-settings/roles/roles-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Role" height="28" width="28" border="0/">
          </a>
          @endcan
          <a href>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Permissions</th>
                  @can('Edit Roles')
...
// $(document).ready(function() {
 ...
 {data: 'permissions', name: 'permissions', searchable: true},
 @can('Edit Roles')
