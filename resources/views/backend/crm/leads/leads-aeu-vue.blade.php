...
<div id="app">
    @if(isset($id) && isset($datatableid) )
        <leads :idm="{{$id}}" :datatableid="{{$datatableid}}"></leads>
...
<script type="text/javascript">
  ...
  $('#contact').mask('+920000000000', {'translation': {
    '9': {pattern: /[9-9]/, optional: false}
  }
});
/*
    $('#contact').mask('+920000000000');*/
    //$('#company_number').mask('00000000000');
</script>
@endpush