...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Leads</h6>
...
<li><a href="{{ url('crm') }}">Customer Relationship & Management</a></li>
   <li><a href="{{ url('crm/leads-vue') }}">Leads List</a></li>
   <li><a href>Deleted Leads</a></li>
</ul>        
      @if($errors->any())
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('leads_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            {data: 'company_number', name: 'company_number', searchable: true},
            {data: 'status', name: 'status', searchable: true},
            {data: 'created_at', name: 'created_at', searchable: true},
            {data: 'user', name: 'user', searchable: true},
                  { data: 'deleted_at', name: 'deleted_at', searchable: true},
                       { data: 'deleted_by', name: 'deleted_by', searchable: true},
               { data: 'delete_comments', name: 'delete_comments', searchable: false},
            @can('Restore Leads')
