...
<div class="br-pagebody">
        <div>
            ...
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Follow Ups</h6>
...
<ul class="breadcrumbee border-bottom-custom">
 ...
 <li><a href="{{ url('crm') }}">Customer Relationship & Management</a></li>
  <li><a href>Follow Ups List</a></li>
</ul>            
