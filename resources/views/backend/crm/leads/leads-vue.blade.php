...
<button type="button" onclick="window.print()" title="Print" class="btn btn-danger btn-sm hidden-print"><i class="fa fa-print"></i></button>
          @can('Add Leads')
          <a href="{{ url('crm/leads/leads-aeu-vue') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Lead" height="28" width="28" border="0/">
          </a>
          @endcan 
          @can('View Deleted Leads')
          <a href="{{ url('crm/leads/deleted') }}">
...
<div class="row ml-1  border-bottom-custom ">
    <div >
        <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 margara ">Leads</h6>
...
<!-- 
@can('Import and Export Sample Data')
 ...
 <form action="{{ route('import') }}" method="POST" enctype="multipart/form-data">
         ...
         <button class="btn btn-success">Import Sample Data</button>
         <a class="btn btn-warning" href="{{ route('export') }}">Export Sample Data</a>
     </form> 
   </div>
   @endcan -->
 ...
 <div id="modal" class="modal fade" role="dialog">
                <div class="modal-dialog modal-lg">
                    ...
                    <div class="modal-content">
                        <form method="post" action="{{route('leads.export')}}">
                            {{csrf_field()}}
...
<script>
// Get the modal
var modal = document.getElementById('callmodall');
