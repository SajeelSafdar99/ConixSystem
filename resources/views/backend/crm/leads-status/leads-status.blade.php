...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Leads Status</h6>
            ...
            @can('Add Leads Status')
          <a href="{{ url('crm/leads-status/leads-status-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Status" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Leads Status')
          <a href="{{ url('crm/leads-status/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Leads Status List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Leads Status')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Leads Status')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('leads_status.datatable') }}',
          'type': 'POST',
          'headers': {
