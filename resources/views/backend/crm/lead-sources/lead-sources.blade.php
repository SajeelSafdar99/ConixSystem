...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Lead Sources</h6>
            ...
            @can('Add Lead Sources')
          <a href="{{ url('crm/lead-sources/lead-sources-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Source" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Lead Sources')
          <a href="{{ url('crm/lead-sources/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Lead Sources List</a></li>
</ul>            
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('lead_sources.datatable') }}',
          'type': 'POST',
          'headers': {
