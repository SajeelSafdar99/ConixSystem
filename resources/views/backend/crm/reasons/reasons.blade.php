...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Reasons / Remarks</h6>
            ...
            @can('Add Reasons')
          <a href="{{ url('crm/reasons/reasons-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Reason" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Reasons')
          <a href="{{ url('crm/reasons/deleted') }}">
