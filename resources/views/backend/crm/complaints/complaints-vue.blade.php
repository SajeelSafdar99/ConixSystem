...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Complaints</h6>
...
<button type="button" onclick="window.print()" title="Print"
             ...
             @can('Add Complaints')
          <a href="{{ url('crm/complaints/complaints-aeu-vue') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Complaint" height="28" width="28" border="0/">
          </a>
            @endcan
          @can('View Deleted Complaints')
          <a href="{{ url('crm/complaints/deleted-vue') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Complaints List</a></li>
</ul>   
