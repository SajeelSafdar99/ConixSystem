...
<div class="br-pagebody">
 ...
 @if($records<1)
             @can('Add Sales Terms and Conditions')
          <a href="{{ url('sales/terms-and-conditions/terms-and-conditions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Item Category" height="28" width="28" border="0/">
          </a>
          @endcan
      @endif
          @can('View Deleted Sales Terms and Conditions')
          <a href="{{ url('sales/terms-and-conditions/deleted') }}">
 ...
 <li><a href="{{ url('sales') }}">Sales</a></li>
  ...
  <li><a href>Terms & Conditions List</a></li>
</ul>
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Terms & Conditions</th>
                 
                  @can('Edit Sales Terms and Conditions')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Sales Terms and Conditions')
...
// $(document).ready(function() {
        ...
        columns: [   
            ...
            {data: 'terms_and_conditions', name: 'terms_and_conditions', searchable: true},
