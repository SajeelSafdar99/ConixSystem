...
<div class="br-pagebody">
        ...
        <div class="hidden-print" style="text-align: right; margin-top: -39px;">
           @can('Add Salary Deductions')
          <a href="{{ url('human-resource/salary-deductions/salary-deductions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Deduction" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Salary Deductions')
          <a href="{{ url('human-resource/salary-deductions/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Salary Deductions List</a></li>
</ul>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Trans Type</th>
                  <th class="wd-10p">Amount</th>
                  <th class="wd-15p">Status</th>
                   @can('Edit Salary Deductions')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Salary Deductions')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('salary_ded.datatable') }}',
          'type': 'POST',
          'headers': {
