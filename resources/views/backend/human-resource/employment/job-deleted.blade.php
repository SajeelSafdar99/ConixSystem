...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Employment History</h6>
...
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  ...
  <li><a href="{{ url('human-resource/employment-vue') }}">Employments List</a></li>
   <li><a href="{{ url('human-resource/employment/job-aeu') }}/{{Request::segment(4)}}">Employment History List</a></li>
  <li><a href>Deleted Employment History</a></li>
</ul>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('job_deleted.datatable',$employee_data->id) }}',
          'type': 'POST',
          'headers': {
