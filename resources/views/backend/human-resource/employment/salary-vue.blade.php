...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Employee Salary Vouchers</h6>
...
<button type="button" onclick="window.print()" title="Print"
          ...
          @can('View Deleted Employee Salary Vouchers')
          <a href="{{ url('human-resource/employment/voucher/deleted-vue') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Employee Salary Vouchers List</a></li>
</ul>   
...
<div id="app">
         <employeesalarydt></employeesalarydt>
</div>
