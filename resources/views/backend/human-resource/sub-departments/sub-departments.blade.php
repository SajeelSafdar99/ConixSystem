...
<div class="br-pagebody">
        <div>
         ...
         <div style="text-align: right; margin-top: -39px;">
           @can('Add Sub-Departments')
          <a href="{{ url('human-resource/sub-departments/sub-departments-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Sub-Department" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Sub-Departments')
          <a href="{{ url('human-resource/sub-departments/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Sub-Departments List</a></li>
</ul>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Sub-Department</th>
                  <th class="wd-15p">Status</th>
                   @can('Edit Sub-Departments')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Sub-Departments')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('sub_departments.datatable') }}',
          'type': 'POST',
          'headers': {
