...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('human-resource/employee-in-out-vue') }}">Employee In & Out List</a></li>
    <li><a href>Edit Employee In / Out</a></li>
</ul>            
 @else
 <ul class="breadcrumbee border-bottom-custom">
    <li><a href="{{ url('/') }}">Home</a></li>
    <li><a href="{{ url('human-resource') }}">Human Resource Management</a></li>
    <li><a href="{{ url('human-resource/employee-in-out-vue') }}">Employee In & Out List</a></li>
    <li><a href>Add Employee In / Out</a></li>
</ul>            
 @endif
...
<div id="app">
    @if(isset($id) && isset($datatableid) )
        <employeeinout :idm="{{$id}}" :datatableid="{{$datatableid}}"></employeeinout>
