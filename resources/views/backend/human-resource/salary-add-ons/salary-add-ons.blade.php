...
<div class="br-pagebody">
        ...
        <div class="hidden-print" style="text-align: right; margin-top: -39px;">
           @can('Add Salary Add-Ons')
          <a href="{{ url('human-resource/salary-add-ons/salary-add-ons-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Add-On" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Salary Add-Ons')
          <a href="{{ url('human-resource/salary-add-ons/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Salary Add-Ons List</a></li>
</ul>
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Status</th>
                   @can('Edit Salary Add-Ons')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Salary Add-Ons')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('salary_addons.datatable') }}',
          'type': 'POST',
          'headers': {
