...
<div class="br-pagebody">
        <div>
         ...
         <div style="text-align: right; margin-top: -39px;">
           @can('Add Departments')
          <a href="{{ url('human-resource/departments/departments-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Department" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Departments')
          <a href="{{ url('human-resource/departments/deleted') }}">
