...
<li><a href>Deleted Purchases</a></li>
</ul>        
      @if($errors->any())
            ...
            <table class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">Suplier #</th>
       <!--             <th class="wd-15p">Store Location</th> -->
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('store_purchases_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
