...
<div class="br-pagebody">
        <div>
          ...
          <div style="text-align: right; margin-top: -39px;">
            @can('Add Store Departments')
          <a href="{{ url('store-management/store-departments/store-departments-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Store Department" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Store Departments')
          <a href="{{ url('store-management/store-departments/deleted') }}">
...
<li><a href="{{ url('store-management/definitions') }}">Definitions</a></li>
  <li><a href>Store Departments List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Store Departments')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Store Departments')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('store_departments.datatable') }}',
          'type': 'POST',
          'headers': {
