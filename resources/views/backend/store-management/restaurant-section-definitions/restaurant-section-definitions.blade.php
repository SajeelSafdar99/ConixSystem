...
<div class="br-pagebody">
        <div>
          ...
          <div style="text-align: right; margin-top: -39px;">
            @can('Add Restaurant Section Definitions')
          <a href="{{ url('store-management/restaurant-section-definitions/restaurant-section-definitions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Section" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Restaurant Section Definitions')
          <a href="{{ url('store-management/restaurant-section-definitions/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Restaurant Section Definitions List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Restaurant Section Definitions')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Restaurant Section Definitions')
