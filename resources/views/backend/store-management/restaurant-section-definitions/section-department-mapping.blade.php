...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Section Department Mapping List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Departments</th>
                  @can('Link Sections and Departments')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('mapping_sections.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            {data: 'departments', name: 'departments', orderable: false},
             @can('Link Sections and Departments')
