...
<div class="br-pagebody">
        <div>
          ...
          <div style="text-align: right; margin-top: -39px;">
            @can('Add Store Location')
          <a href="{{ url('store-management/store-locations/store-locations-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Store Location" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Store Locations')
          <a href="{{ url('store-management/store-locations/deleted') }}">
...
<li><a href="{{ url('store-management/definitions') }}">Definitions</a></li>
  <li><a href>Store Locations List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Store Location')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Store Location')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('store_locations.datatable') }}',
          'type': 'POST',
          'headers': {
