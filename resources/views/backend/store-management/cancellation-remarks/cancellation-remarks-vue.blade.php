...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Cancellation Remarks</h6>
...
<button type="button" onclick="window.print()" title="Print"
             ...
             @can('Add Cancellation Remarks')
          <a href="{{ url('store-management/cancellation-remarks/cancellation-remarks-aeu-vue') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Remark" height="28" width="28" border="0/">
          </a>
            @endcan
          @can('View Deleted Cancellation Remarks')
          <a href="{{ url('store-management/cancellation-remarks/deleted-vue') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Cancellation Remarks List</a></li>
</ul>   
...
<div id="app">
         <cancelremarksdt></cancelremarksdt>
</div>
