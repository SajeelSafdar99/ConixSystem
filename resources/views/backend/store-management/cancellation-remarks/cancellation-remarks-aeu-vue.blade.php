...
<ul class="breadcrumbee border-bottom-custom">
   ...
   <li><a href="{{ url('store-management') }}">Store Management</a></li>
    ...
    <li><a href="{{ url('store-management/cancellation-remarks-vue') }}">Cancellation Remarks List</a></li>
    <li><a href>Edit Cancellation Remark</a></li>
</ul>            
 @else
 <ul class="breadcrumbee border-bottom-custom">
    <li><a href="{{ url('/') }}">Home</a></li>
   <li><a href="{{ url('store-management') }}">Store Management</a></li>
     <li><a href="{{ url('store-management/definitions') }}">Definitions</a></li>
    <li><a href="{{ url('store-management/cancellation-remarks-vue') }}">Cancellation Remarks List</a></li>
    <li><a href>Add Cancellation Remark</a></li>
</ul>            
 @endif
...
<div id="app">
    @if(isset($id) && isset($datatableid) )
        <cancelremarks :idm="{{$id}}" :datatableid="{{$datatableid}}"></cancelremarks>
