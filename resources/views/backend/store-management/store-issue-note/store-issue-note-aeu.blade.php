...
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  ...
  <li><a href>Edit Store Issue Note</a></li>
</ul>
@else
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  <li><a href="{{ url('/') }}">Home</a></li>
  <li><a href="{{ url('store-management') }}">Store Management</a></li>
  <li><a href="{{ url('store-management/store-issue-note-vue') }}">Store Issue Note List</a></li>
  <li><a href>Add Store Issue Note</a></li>
</ul>
@endif
...
<div id="app" style="color: black;">
    @if(isset($id))
        <storeissuenote :id="{{$id}}" :linking="'{{url('/')}}'"></storeissuenote>
        @else
        <storeissuenote :linking="'{{url('/')}}'"></storeissuenote>
