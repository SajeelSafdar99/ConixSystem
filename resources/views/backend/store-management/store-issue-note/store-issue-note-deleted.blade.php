...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Store Issue Note</h6>
...
<li><a href>Deleted Store Issue Notes</a></li>
</ul>        
      @if($errors->any())
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('issue_note_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
