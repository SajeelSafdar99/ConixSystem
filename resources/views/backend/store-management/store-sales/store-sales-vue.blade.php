...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">General Sales</h6>
        ...
        <button type="button" onclick="window.print()" title="Print"
          ...
          @can('Add Store Sales')
          <a href="{{ url('store-management/store-sales/store-sales-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Sale" height="28" width="28" border="0/">
          </a>
          @endcan 
          @can('View Deleted Store Sales')
          <a href="{{ url('store-management/store-sales/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>General Sales List</a></li>
</ul>            
