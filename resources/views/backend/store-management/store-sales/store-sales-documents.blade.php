...
<div class="br-pagebody">
          ...
          <h5 class="tx-gray-800 tx-uppercase tx-bold tx-18 mg-b-10" style="text-align: center;">STORE SALES DOCUMENTS<br>(INVOICE #: {{$receiptdata->id}})</h5>
...
<br>
   ...
   @foreach($receiptdata->storeSalesDocs->pluck('url') as $image)
