...
<div class="br-pagebody">
     ...
     <div class="hidden-print" style="text-align: right; margin-top: -39px;">
          @can('Add Menu Type')
          <a href="{{ url('events-management/menu-type/menu-type-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Menu Type" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Menu Types')
          <a href="{{ url('events-management/menu-type/deleted') }}">
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-20p">Menu Type</th>
                  <th class="wd-15p">Status</th>
                  @can('Edit Menu Type')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Menu Type')
