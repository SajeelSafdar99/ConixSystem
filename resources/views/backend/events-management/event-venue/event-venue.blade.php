...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Venues')
          <a href="{{ url('events-management/event-venue/event-venue-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Event Venue" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Venues')
          <a href="{{ url('events-management/event-venue/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Event Venue List</a></li>
</ul>
