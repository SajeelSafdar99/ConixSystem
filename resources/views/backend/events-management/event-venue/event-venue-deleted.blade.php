...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Event Venues</h6>
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href="{{ url('events-management/event-venue') }}">Event Venues List</a></li>
  <li><a href>Deleted Event Venues</a></li>
</ul>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('venue_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
