...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Menu Add Ons')
          <a href="{{ url('events-management/menu-add-ons/menu-add-ons-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Menu Add-On" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Menu Add Ons')
          <a href="{{ url('events-management/menu-add-ons/deleted') }}">
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Menu Add-Ons List</a></li>
</ul>        
      @if($errors->any())
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                 ...
                 @can('Edit Menu Add Ons')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Menu Add Ons')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('menu_addon.datatable') }}',
          'type': 'POST',
          'headers': {
