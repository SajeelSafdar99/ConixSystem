...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href="{{ url('events-management/menu-category') }}">Menu Rate Category List</a></li>
  <li><a href>Deleted Menu Rate Categories</a></li>
</ul>
            ...
            <table class="table display nowrap datatable">
              ...
              <thead>
                <tr> 
                  ...
                  @can('Restore Menu Rate Category')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('menucategory_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
