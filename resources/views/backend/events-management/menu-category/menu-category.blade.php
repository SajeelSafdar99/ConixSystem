...
<div class="br-pagebody">
        <div>
          ...
          <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            @can('Add Menu Rate Category')
            <a href="{{ url('events-management/menu-category/menu-category-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Menu Category" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Menu Rate Categories')
          <a href="{{ url('events-management/menu-category/deleted') }}">
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Menu Rate Categories List</a></li>
</ul>         
      @if($errors->any())
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Status</th>
                   @can('Edit Menu Rate Category')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Menu Rate Category')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('menucategory.datatable') }}',
          'type': 'POST',
          'headers': {
