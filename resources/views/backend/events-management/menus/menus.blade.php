...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Menus')
          <a href="{{ url('events-management/menus/menus-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Menu" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Menus')
          <a href="{{ url('events-management/menus/deleted') }}">
...
// $(document).ready(function() {
        ...
        columns: [   
          ...
          //   },
            ...
            {data: 'menu_name', name: 'menu_name', searchable: true},
