...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Menus</h6>
        ...
        <table id="menutable" align="center" border="0" width="100%">
           ...
           <tr>
            <td width="15%" align="left">&nbsp</td>
                                                        <td width="80%" align="left">Item Name<span class="tx-danger">*</span></td>
...
<div class="row mg-t-10">
                  ...
                  <div class="col-sm-10 mg-t-10 mg-sm-t-0">
              <input @if ($errors->has('total')) style="border-color:red;" @endif type="number" id="total" name="total" class="form-control input-height" placeholder="Enter Total Charges of the Menu" value="@if($init==0){{old('total')}}@else{{old('total',$menus_update->total)}}@endif">
                  </div>
                </div>
 <div class="row mg-t-10">
