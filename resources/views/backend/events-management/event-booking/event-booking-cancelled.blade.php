...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara" >Event Cancellation</h6>
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  <li><a href="{{ url('events-management') }}">Events Management</a></li>
   <li><a href>Cancelled Event Bookings List</a></li>
</ul>        
      @if($errors->any())
          ...
          <div class="table-wrapper">
            ...
            <table class="table display nowrap datatable">
              ...
              <thead>
                ...
                <th class="wd-20p">Cancellation Details</th>
                @can('Confirm Cancelled Event')
                <th class="wd-10p">Undo</th>  
                 @endcan           
                </tr>
              </thead>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('event_booking_cancelled.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            {data: 'to', name: 'to', searchable: false},
             ...
             {data: 'cancel_details', name: 'cancel_details', searchable: false, orderable: false}, 
             @can('Confirm Cancelled Event')
            {data: 're-confirm', name: 're-confirm', orderable: false},
            @endcan    
        ]
    });
