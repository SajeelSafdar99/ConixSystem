...
<form method="post" action="{{ url('events-management/event-booking/cancel/') }}/{{ $cancel_update->id }}">
    @csrf
<div id="modaldemo1" class="modal fade">
            <div class="modal-dialog modal-dialog-vertical-center" role="document" style="width: 1000px;">
              <div class="modal-content bd-0 tx-14">
                <div class="modal-header pd-y-20 pd-x-25">
                  <h6 class="tx-14 mg-b-0 tx-uppercase tx-inverse tx-bold">Event Booking Cancellation</h6>
                </div>
...
<div id="error_msg" class="col-sm-6 col-sm-offset-3 alert alert-success text-center">{{$errors->first()}}
 ...
 <div class="row ">
                  ...
                  <textarea @if($errors->has('cancel_details'))style="border-color:red;"
                                                            @endif id="cancel_details" class="form-control"
                                                            placeholder="Give reason / details" rows="2" type="text"
                                                            name="cancel_details">{{old('cancel_details')}}</textarea>
                  </div>
              </div>
                 ...
                 <div class="modal-footer">
                     <button type="input" name="save" class="btn btn-primary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Save</button>
                  <a href="{{ url('events-management/event-booking-vue') }}" class="btn btn-secondary tx-11 tx-uppercase pd-y-12 pd-x-25 tx-mont tx-medium">Cancel</a>
