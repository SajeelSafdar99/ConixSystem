        ...
        <div>
            ...
            @if($init==1)
                <ul class="breadcrumbee mg-b-25   border-bottom-custom">
                    ...
                    <li><a href>Edit Event Booking</a></li>
                </ul>
            @else
                <ul class="breadcrumbee mg-b-25   border-bottom-custom">
                    <li><a href="{{ url('/') }}">Home</a></li>
                    <li><a href="{{ url('events-management') }}">Events Management</a></li>
                    <li><a href="{{ url('events-management/event-booking-vue') }}">Event Booking List</a></li>
                    <li><a href>Add Event Booking</a></li>
                </ul>
            @endif
...
@endif
            ...
            @if($init==1)
    <form method="post" enctype="multipart/form-data" action="{{ url('events-management/event-booking/update') }}/{{ $event_booking_update->id }}">
     @else
...
<div class="row mg-t-10">
    ...
    <input id="booking_no" class="form-control input-height" type="number" readonly value="@if($init==0){{$increment_number}}@else{{old('booking_no', $event_booking_update->booking_no)}}@endif"
           ...
           <div class="row mg-t-10">
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
              <input  @if ($errors->has('booking_date')) style="border-color:red;" @endif id="booking_date" class="form-control input-height" type="text" value="@if($init==0)<?php echo $today;?>@else{{old('booking_date',formatDateToShow($event_booking_update->booking_date))}}@endif" name="booking_date" readonly style="background-color: #c1c1c1">
 ...
 @if($init==1)   <div class="col-sm-3 mg-t-10 mg-sm-t-0">
      <label class="rdiobox">
    <input @if($init==0) checked="" @else @if(old('booking_type',$event_booking_update->booking_type)=='0') checked="" @endif @endif type="radio" name="booking_type" value="0"><span class="pabs">Member</span>
              </label>
            </div><!-- col-3 -->
                                <div class="col-sm-3 mg-t-10 mg-sm-t-0">
                <label class="rdiobox">
    <input @if(old('booking_type',$event_booking_update->booking_type)=='1') checked="" @endif type="radio" name="booking_type" value="1"><span class="pabs">Guest</span>
              </label>
            </div><!-- col-3 -->
    ...
    <input @if(old('booking_type')=='1') checked="" @endif type="radio" name="booking_type" value="1"><span class="pabs">Guest / Non-Member</span>
                             ...
                             @endif
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                             <input @if($errors->has('moc_name')) style="border-color:red;"  @endif id="moc_name" class="form-control input-height typeahead" placeholder="Enter to Search" autocomplete="off" value="@if($init==0){{old('moc_name')}}@else{{old('moc_name',$event_booking_update->moc_name)}}@endif"
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-4 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('member_id')) style="border-color:red;"
                                                               ...
                                                               value="@if($init==0){{old('member_code')}}@else{{old('member_code',$event_booking_update->member?$event_booking_update->member->mem_no:'') }}@endif"
                                                               type="text" name="member_code">
                                                        <input @if ($errors->has('member_id')) style="border-color:red;"
                                                               @endif id="member_id" class="form-control input-height"
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('member_id')}}@else{{old('member_id',$event_booking_update->member_id)}}@endif"
                                                    ...
                                                    <div class="col-sm-4 mg-t-10 mg-sm-t-0">
                                                        <input
                                                            ...
                                                            readonly style="background-color: #c1c1c1"
                                                            value="@if($init==0){{old('customer_id')}}@else{{old('customer_id',$event_booking_update->customer_id)}}@endif"
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input
                                                            ...
                                                            readonly style="background-color: #c1c1c1"
                                                            value="@if($init==0){{old('moc_address')}}@else{{old('moc_address',$event_booking_update->moc_address)}}@endif"
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('moc_cnic')) style="border-color:red;"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('moc_cnic')}}@else{{old('moc_cnic',$event_booking_update->moc_cnic)}}@endif"
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('moc_mob')) style="border-color:red;"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('moc_mob')}}@else{{old('moc_mob',$event_booking_update->moc_mob)}}@endif"
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('moc_email')) style="border-color:red;"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('moc_email')}}@else{{old('moc_email',$event_booking_update->moc_email)}}@endif"
...
<a href="{{ url('finance-and-management/finance-ledger-accounts') }}" target="_blank">
      ...
      <div class="col-sm-9 mg-t-10 mg-sm-t-0">
<input @if ($errors->has('ledger_amount')) style="border-color:red;" @endif  type="number" class="form-control input-height" id="ledger_amount" name="ledger_amount" autocomplete="off" readonly style="background-color: #c1c1c1" value="@if($init==0){{old('ledger_amount')}}@else{{old('ledger_amount',$event_booking_update->ledger_amount)}}@endif">
</div>
</div>
         ...
         @if($init==1)
          <option
           @if(old('family',$event_booking_update->family)==$fm->id)  selected  @endif  value="{{ $fm->id }}"> {{ $fm->name }} ({{ $fm->relationship_name->desc }})
                         </option>  @else
            <option
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('booked_by')) style="border-color:red;"
                                                               ...
                                                               value="@if($init==0){{old('booked_by')}}@else{{old('booked_by',$event_booking_update->booked_by)}}@endif"
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input @if ($errors->has('nature_of_event')) style="border-color:red;"
                                                               ...
                                                               value="@if($init==0){{old('nature_of_event')}}@else{{old('nature_of_event',$event_booking_update->nature_of_event)}}@endif"
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        ...
                                                        <input
                                                            ...
                                                            value="@if($init==0){{old('event_date')}}@else{{old('event_date',formatDateToShow($event_booking_update->event_date))}}@endif"
                                                            name="event_date">
                                                   ...
                                                   Timing (From):
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input
                                                            ...
                                                            value="@if($init==0){{old('from')}}@else{{old('from',$event_booking_update->from)}}@endif" name="from">
                                                    </div>
<script>
                                                   ...
                                                   Timing (To):
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input
                                                            ...
                                                            autocomplete="off" type="text" placeholder="hh:mm AM/PM"
                                                            value="@if($init==0){{old('to')}}@else{{old('to',$event_booking_update->to)}}@endif" name="to">
                                                    </div>
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <select @if ($errors->has('venue')) style="border-color:red;"
                                                            ...
                                                            @foreach($venue as $venues)
                                                                @if($init==1)
                                                                    <option
                                                                        @if(old('venue',$event_booking_update->venue)==$venues->id)  selected
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <select onchange="menuChargesSelect(this.id)" @if ($errors->has('menu')) style="border-color:red;"
                                                            ...
                                                            @foreach($menu as $menus)
                                                                @if($init==1)
                                                                    <option
                                                                        @if(old('menu',$event_booking_update->menu)==$menus->id)  selected
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <select @if ($errors->has('menu_category')) style="border-color:red;" @endif id="menu_category"
                                                            ...
                                                            @foreach($menu_category as $menucategory)
                                                                @if($init==1)
                                                                    <option
                                                                        @if(old('menu_category',$event_booking_update->menu_category)==$menucategory->id)  selected
                                                                        @endif  value="{{ $menucategory->id }}">
                                                                        {{ $menucategory->desc }}
                                                                    </option>
                                                                @else
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input
                                                            ...
                                                            value="@if($init==0){{old('menu_charges')}}@else{{old('menu_charges',$event_booking_update->menu_charges)}}@endif"
...
<div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               class="form-control input-height" readonly
                                                               style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('total_addon_charges')}}@else{{old('total_addon_charges',$event_booking_update->total_addon_charges)}}@endif" name="total_addon_charges">
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               class="form-control input-height" readonly
                                                               style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('total_per_person_charges')}}@else{{old('total_per_person_charges',$event_booking_update->total_per_person_charges)}}@endif" name="total_per_person_charges">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                      @if($init==1)
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('guests')}}@else{{old('guests',$event_booking_update->guests)}}@endif" name="guests" readonly style="background-color: #c1c1c1">
                                                                  @else
                                                               <input type="number"
                                                               @if ($errors->has('guests')) style="border-color:red;"
                                                               @endif id="guests" placeholder="Enter Total Number of Guests" class="form-control input-height" autocomplete="off" oninput="chargesselect()"
                                                               value="@if($init==0){{old('guests')}}@else{{old('guests',$event_booking_update->guests)}}@endif" name="guests">
                                                              @endif
                                                    </div>
                                                </div>
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('total_food_charges')}}@else{{old('total_food_charges',$event_booking_update->total_food_charges)}}@endif"
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                      @if($init==1)
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('extra_guests')}}@else{{old('extra_guests',$event_booking_update->extra_guests)}}@endif" name="extra_guests">
                                                               @else
                                                              <input type="number"
                                                               @if ($errors->has('extra_guests')) style="border-color:red;"
                                                               @endif id="extra_guests" class="form-control input-height" autocomplete="off" oninput="extra_guestcharges()"
                                                               value="@if($init==0){{old('extra_guests')}}@else{{old('extra_guests',$event_booking_update->extra_guests)}}@endif" name="extra_guests" readonly style="background-color: #c1c1c1">
                                                               @endif
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('extra_food_charges')}}@else{{old('extra_food_charges',$event_booking_update->extra_food_charges)}}@endif"
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('grand_guest_charges')}}@else{{old('grand_guest_charges',$event_booking_update->grand_guest_charges)}}@endif" name="grand_guest_charges">
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               class="form-control input-height" readonly
                                                               style="background-color: #c1c1c1"
                                                               value="@if($init==0){{old('total_other_charges')}}@else{{old('total_other_charges',$event_booking_update->total_other_charges)}}@endif" name="total_other_charges">
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('total_charges')}}@else{{old('total_charges',$event_booking_update->total_charges)}}@endif" name="total_charges">
                                                 ...
                                                 <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-3 mg-t-5 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('surcharge')}}@else{{old('surcharge',$event_booking_update->surcharge)}}@endif" name="surcharge" oninput="calculate_total()">
                                                    ...
                                                    <div class="col-sm-2 mg-t-4 mg-sm-t-0 pc">
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('surcharge_percentage')}}@else{{old('surcharge_percentage',$event_booking_update->surcharge_percentage)}}@endif" name="surcharge_percentage" oninput="calculate_total()">
                                                    ...
                                                    <div class="col-sm-2 mg-t-10 mg-sm-t-0" id="surcharge_div">
                                                        <textarea
                                                            ...
                                                            name="surcharge_details">@if($init==0){{old('surcharge_details')}}@else{{old('surcharge_details',$event_booking_update->surcharge_details)}}@endif</textarea>
                                                    </div>
                                                  </div>
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               style="background-color: #c1c1c1"
                                                               onclick="calculate_total()"
                                                               value="@if($init==0){{old('surcharge_total')}}@else{{old('surcharge_total',$event_booking_update->surcharge_total)}}@endif" name="surcharge_total">
                                            ...
                                            <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-3 mg-t-5 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               class="form-control input-height"
                                                               placeholder="Enter Amount" autocomplete="off"
                                                               value="@if($init==0){{old('discount_amount')}}@else{{old('discount_amount',$event_booking_update->discount_amount)}}@endif" name="discount_amount" oninput="calculate_total()">
                                                    ...
                                                    <div class="col-sm-2 mg-t-4 mg-sm-t-0 pc">
                                                        <input type="number"
                                                               ...
                                                               class="form-control input-height" autocomplete="off"
                                                               value="@if($init==0){{old('discount_percentage')}}@else{{old('discount_percentage',$event_booking_update->discount_percentage)}}@endif" name="discount_percentage" oninput="calculate_total()">
                                                    ...
                                                    <div class="col-sm-2 mg-t-10 mg-sm-t-0" id="reduction_div">
                                                        <textarea
                                                            ...
                                                            placeholder="Give any details" rows="2" type="text"
                                                            name="discount_details">@if($init==0){{old('discount_details')}}@else{{old('discount_details',$event_booking_update->discount_details)}}@endif</textarea>
                                                    </div>
                                                </div>
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               style="background-color: #c1c1c1"
                                                               onclick="calculate_total()"
                                                               value="@if($init==0){{old('grand_total')}}@else{{old('grand_total',$event_booking_update->grand_total)}}@endif" name="grand_total">
      ...
      <div class="row mg-t-10">
         ...
         <!--         <div class="row mg-t-10">
                      ...
                      Amount Paid:
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="number" @if ($errors->has('amount_paid')) style="border-color:red;" @endif id="amount_paid" class="form-control input-height" name="amount_paid" value="@if($init==0){{old('amount_paid')}}@else{{old('amount_paid',$event_booking_update->amount_paid)}}@endif" oninput="calculate_total()" readonly style="background-color: #c1c1c1" autocomplete="off">
                 ...
                 <span class="tx-danger">
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                            <input type="number" @if ($errors->has('grand_balance')) style="border-color:red;" @endif id="grand_balance" class="form-control input-height" value="@if($init==0){{old('grand_balance')}}@else{{old('grand_balance',$event_booking_update->grand_balance)}}@endif" readonly style="background-color: #c1c1c1" name="grand_balance">
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               readonly style="background-color: #c1c1c1"
                                                               onclick="calculate_total()" value="@if($init==0){{old('grand_total')}}@else{{old('grand_total',$event_booking_update->grand_total)}}@endif" name="grand_total">
...
<div class="row mg-t-10">
                                ...
                                *
                                        ...
                                        @foreach($payment_methods as $methods)
                                                                @if($init==1)
                           <option  @if(old('payment_mode',$event_booking_update->payment_mode)==$methods->id)  selected  @endif  value="{{ $methods->id }}">  {{ $methods->desc }}
                    </option>
                                   @else
 ...
 <label class="col-sm-1 form-control-label" style="color: black;">
                                                    ...
                                                    <div class="col-sm-4 mg-t-4 mg-sm-t-0">
                                                        <textarea
                                                            ...
                                                            placeholder="Give any details" rows="2" type="text"
                                                            name="payment_mode_details">@if($init==0){{old('payment_mode_details')}}@else{{old('payment_mode_details',$event_booking_update->payment_mode_details)}}@endif</textarea>
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               value="@if($init==0){{old('advance_paid')}}@else{{old('advance_paid',$event_booking_update->advance_paid)}}@endif"
                                ...
                                *
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <input type="number"
                                                               ...
                                                               style="background-color: #c1c1c1"
                                                               onclick="calculate_total()"
                                                               value="@if($init==0){{old('total_balance')}}@else{{old('total_balance',$event_booking_update->total_balance)}}@endif" name="total_balance">
     ...
     <div class="row mg-t-10">
                    ...
                    Documents:
                        ...
                        <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                             ...
                             @else
@if($event_booking_update->booking_type==0)

    @foreach($event_booking_update->eventDocs->pluck('url') as $image)
...
@else
{{--@dd($event_booking_update->customer_id)--}}
                                    @foreach($event_booking_update->eventDocs->pluck('url') as $image)
 <a href="{{url($image)}}" target="_blank">
...
<input type="file" name="booking_docs[]" multiple="multiple">
                            ...
                            <input type="hidden" name="existimg" value="{{old('booking_docs',$event_booking_update->booking_docs)}}">
                            @endif
                                                ...
                                                <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <textarea
                                                            ...
                                                            placeholder="Give any details" rows="2" type="text"
                                                            name="additional_notes">@if($init==0){{old('additional_notes')}}@else{{old('additional_notes',$event_booking_update->additional_notes)}}@endif</textarea>
            ...
            $.ajax({
                ...
                success: function (data) {
                  ...
                  $lname=obj.applicant_name?obj.applicant_name:'';
                        ...
                        document.getElementById('ledger_amount').value=obj.balance;
         let selected="{{$init==1?$event_booking_update->family:''}}";
        $('#family').html('<option label="Choose Family Member">  </option>');
