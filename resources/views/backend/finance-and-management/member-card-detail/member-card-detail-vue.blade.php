...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Member Card Detail Report</h6>
...
<button type="button" onclick="window.print()" title="Print"
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/reports/member-card-detail-report-vue') }}">Member Card Detail</a></li>
</ul>
