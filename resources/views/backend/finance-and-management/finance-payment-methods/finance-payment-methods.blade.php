...
<div class="br-pagebody">
        <div>
          ...
          <a href="{{ url('finance-and-management/finance-payment-methods/finance-payment-methods-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Payment Method" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Payment Methods')
          <a href="{{ url('finance-and-management/finance-payment-methods/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Payment Methods List</a></li>
</ul>
