...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  margara">Item Closing Stock Details (Issuance-Wise)</h6>
...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/store-management/reports') }}">Store Management Reports</a></li>
    <li><a href>Item Closing Stock Details (Issuance-Wise)</a></li>
</ul>          
...
<div id="app">
    <itemissueclosingstockdetails></itemissueclosingstockdetails>
</div>
