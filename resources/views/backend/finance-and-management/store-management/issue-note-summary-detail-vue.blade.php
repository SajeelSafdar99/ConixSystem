...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Issue Note Summary Detail</h6>
...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href>Issue Note Summary Detail List</a></li>
</ul>          
...
<div id="app">
    <issuenotesummarydetail></issuenotesummarydetail>
</div>
