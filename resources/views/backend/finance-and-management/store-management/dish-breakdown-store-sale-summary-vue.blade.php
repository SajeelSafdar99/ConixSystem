...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Dish Breakdown Store Sale Summary</h6>
...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href>Dish Breakdown Store Sale Summary List</a></li>
</ul>          
...
<div id="app">
    <dishbreakdownstoresales></dishbreakdownstoresales>
</div>
