...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10   margara">Item Closing Stock Details (Sale-Wise)</h6>
...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href>Item Closing Stock Details (Sale-Wise)</a></li>
</ul>          
...
<div id="app">
    <itemsaleclosingstockdetails></itemsaleclosingstockdetails>
</div>
