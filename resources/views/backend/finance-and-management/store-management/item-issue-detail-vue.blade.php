...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Item Issue Detail</h6>
...
<ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href>Item Issue Detail List</a></li>
</ul>          
...
<div id="app">
    <itemissuedetail></itemissuedetail>
</div>
