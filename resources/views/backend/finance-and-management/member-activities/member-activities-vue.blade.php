...
@section('page-content')
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Member Activities</h6>
...
<button type="button" onclick="window.print()" title="Print"
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/reports/member-activities-vue') }}">Member Activities List</a></li>
</ul>
...
<div id="app">
         <memberactivitiesdt></memberactivitiesdt>
</div>
