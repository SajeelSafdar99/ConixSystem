...
<ul class="breadcrumbee mg-b-25 mg-lg-b-50 border-bottom-custom">
  ...
  <li><a href="{{ url('finance-and-management/finance-expenses') }}">Expenses List</a></li>
...
@endif
  ...
  <div class="row">
               <div class="col-sm-5">
                ...
                <br>
               <h6 class="box-title headingsettings"><b>VOUCHER DETAILS</b></h6>
                <br>

<div class="row mg-t-10">

        <label class="col-sm-3 form-control-label">Voucher Number:  <span class="tx-danger">  * </span>  </label>
   <div class="col-sm-9 mg-t-10 mg-sm-t-0">
    <input @if ($errors->has('invoice_no')) style="border-color:red;" @endif type="text" class="form-control input-height" id="invoice_no" name="invoice_no" value="@if($init==0){{$increment_number}}@else{{old('invoice_no',$expenses_update->invoice_no)}}@endif" autocomplete="off" readonly style="background-color: #c1c1c1" style="background-color: #c1c1c1"></div>
  </div>


<div class="row mg-t-10">

        <label class="col-sm-3 form-control-label">Voucher Date:  <span class="tx-danger">  * </span>  </label>
         <?php
...
?>
   <div class="col-sm-9 mg-t-10 mg-sm-t-0">
  <input @if ($errors->has('invoice_date')) style="border-color:red;" @endif type="text" name="invoice_date" id="invoice_date" class="form-control input-height" autocomplete="off" value="@if($init==0)<?php echo $today;?>@else{{old('invoice_date',$expenses_update->invoice_date)}}@endif" readonly style="background-color: #c1c1c1"></div>
  </div>

   <br>
               <h6 class="box-title headingsettings"><b>LEDGER PERSON INFORMATION</b></h6>
                <br>
...
<div class="col-sm-9 mg-t-10 mg-sm-t-0">                                                 
 <input @if($errors->has('person_name')) style="border-color:red;" @endif type="text" class="form-control input-height" id="person_name" name="person_name" onkeyup="customerdata(this.value)" autocomplete="off" class="typeahead" placeholder="Search By Name or ID" value="@if($init==0){{old('person_name')}}@else{{old('person_name',$expenses_update->person_name)}}@endif">
    ...
    <div class="row mg-t-10">
                                                    ...
                                                    <div class="col-sm-9 mg-t-10 mg-sm-t-0">
                                                        <a href="{{ url('finance-and-management/finance_ledger_persons/finance_ledger_persons-aeu') }}"
                                                           target="_blank">
                                                            <input type="button" value="Add New Ledger Person"
                                                                   class="btn btn-info">
                                                        </a>
                                                    </div>
                                                </div>
  <div class="row mg-t-10">
      <label class="col-sm-3 form-control-label">
         Person No.:       <span class="tx-danger">
                                                                      *
                                                                  </span>  </label>
      <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<input @if ($errors->has('person_email')) style="border-color:red;" @endif type="text" class="form-control input-height" id="person_email" name="person_email" autocomplete="off" value="@if($init==0){{old('person_email')}}@else{{old('person_email',$expenses_update->person_email)}}@endif" readonly style="background-color: #c1c1c1">
 ...
 <div class="row mg-t-10">
      <label class="col-sm-3 form-control-label">
         Ledger Amount:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
      <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="col-sm-5">
                                           ...
                                           <br>
               <h6 class="box-title headingsettings"><b>EXPENSES</b></h6>
                <br>


<div class="row">
 <label class="col-sm-3 form-control-label">
         Expense Paid For:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Expense Details:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
<label class="col-sm-3 form-control-label" style="color: black;">Account Head:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
...
<div class="row mg-t-10">
        ...
        <label class="col-sm-3 form-control-label">Account Date:  <span class="tx-danger">  * </span>  </label>
         <?php
...
?>
   <div class="col-sm-9 mg-t-10 mg-sm-t-0">
  <input @if ($errors->has('account_date')) style="border-color:red;" @endif type="text" name="account_date" id="account_date" class="form-control input-height" autocomplete="off" value="@if($init==0)<?php echo $today;?>@else{{old('account_date',$expenses_update->account_date)}}@endif"></div>
  </div>


<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Mode Details:    <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
<textarea @if ($errors->has('payment_mode_details')) style="border-color:red;" @endif type="text" id="payment_mode_details" class="form-control" placeholder="Enter Details" name="payment_mode_details" autocomplete="off">@if($init==0){{old('payment_mode_details')}}@else{{old('payment_mode_details',$expenses_update->payment_mode_details)}}@endif</textarea>
</div>
</div>

<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Total Amount:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Surcharge (If Any):</label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
<input @if ($errors->has('surcharge')) style="border-color:red;" @endif type="number" id="surcharge" name="surcharge" autocomplete="off" oninput="add_surcharge()" class="form-control input-height" value="@if($init==0){{old('surcharge')}}@else{{old('surcharge',$expenses_update->surcharge)}}@endif">
</div>
</div>
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Total Paid Amount:     <span class="tx-danger">
                                                                      *
                                                                  </span></label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
...
<div class="row mg-t-10">
 <label class="col-sm-3 form-control-label">
         Remarks:</label>
         <div class="col-sm-9 mg-t-10 mg-sm-t-0">
<textarea @if ($errors->has('remarks')) style="border-color:red;" @endif type="text" class="form-control" id="remarks" name="remarks" placeholder="Enter Details" autocomplete="off">@if($init==0){{old('remarks')}}@else{{old('remarks',$expenses_update->remarks)}}@endif</textarea>
</div>
</div>
...
<div class="row mg-t-10">
               <label class="col-sm-4 form-control-label"></label>
                ...
                <div class="form-layout-footer mg-t-30">
                  ...
                  &nbsp&nbsp
                  <a href="{{ url('finance-and-management/finance-expenses') }}" class="btn btn-secondary">Cancel</a>
...
$('#person_name').attr('readonly','readonly')
document.getElementById('person_name').onkeyup = null;
...
jQuery.each( JSON.parse(data), function( i, val1 ) {
     ...
     $("#areabox").append(`<li onclick="customerdatavalue('${val1.id}')">${val1.person_name}<li>`);                   
});
