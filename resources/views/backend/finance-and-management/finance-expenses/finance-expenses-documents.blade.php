...
<div class="br-pagebody">
          ...
          <h5 class="tx-gray-800 tx-uppercase tx-bold tx-18 mg-b-10" style="text-align: center;">EXPENSE DOCUMENTS<br>(EXPENSE #: {{$receiptdata->expense_no}})</h5>
...
<br>
   ...
   @foreach($receiptdata->expensesDocs->pluck('url') as $image)
