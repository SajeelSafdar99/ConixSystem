...
.headingsetting{
  color: black !important;
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 hidden-print margara">General Ledger</h6>
...
<button type="button" onclick="window.print()" title="Print"
                ...
                <a href="{{url()->current()}}">
                    <img src="{{ url('assets/images/reload.png') }}" title="Reload Page"
                         height="28" width="28"
                         border="0/">
                </a>
            </div>
    ...
    <ul class="breadcrumbee border-bottom-custom">
                    ...
                    <li><a href="{{url()->current()}}">General Ledger</a></li>
    </ul>
