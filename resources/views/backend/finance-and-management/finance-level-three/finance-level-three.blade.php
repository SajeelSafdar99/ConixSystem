...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Level Three')
          <a href="{{ url('finance-and-management/finance-level-three/finance-level-three-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Level" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Level Three')
          <a href="{{ url('finance-and-management/finance-level-three/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Level Three List</a></li>
</ul>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Level Two</th>
                  <th class="wd-15p">Desc</th>
                  <th class="wd-10p">Status</th>
                 @can('Edit Level Three')
                  <th class="wd-5p">Edit</th>
                  @endcan
                  @can('Delete Level Three')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'desc' ]],
          "ajax": {
          'url': '{{ route('level_three.datatable') }}',
          'type': 'POST',
          'headers': {
