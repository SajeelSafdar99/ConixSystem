...
{{-- Main Nav Bar --}}
 ...
 <div class="col-sm-3">
<a href="{{ url('finance-and-management/finance-voucher-types') }}">
           <div class="col-sm-6 col-xl-12 flip-box cursorpointer" >
            ...
            <div class="pd-25 d-flex align-items-center maindivbg">
                  ...
                  <img src="{{ url('assets/images/finance-and-management/add voucher.png') }}">
<div class="divwidthset">
                  <p class=" mg-b-2 lh-1 icon-below">  <b class="icontexts">&nbsp&nbsp&nbsp&nbspVOUCHER TYPES</b></p></div>
