...
<div class="br-pagebody">
      ...
      <div class="hidden-print" style="text-align: right; margin-top: -39px;">
          @can('Add Voucher Types')
          <a href="{{ url('finance-and-management/finance-voucher-types/finance-voucher-types-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Voucher Type" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Voucher Types')
          <a href="{{ url('finance-and-management/finance-voucher-types/deleted') }}">
...
<li><a href="{{ url('finance-and-management') }}">Finance Management</a></li>
  ...
  <li><a href>Voucher Types List</a></li>
</ul>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                 ...
                 @can('Edit Voucher Types')
                  <th class="wd-5p">Edit</th>
                  @endcan
                  @can('Delete Voucher Types')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('voucher_types.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            @can('Edit Voucher Types')
            {data: 'editbutton', name: 'editbutton', orderable: false, searchable: false},
            @endcan
            @can('Delete Voucher Types')
            {data: 'deletebutton', name: 'deletebutton', orderable: false, searchable: false},
            @endcan         
        ]
    });
