...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Account Heads')
          <a href="{{ url('finance-and-management/finance-account-heads/finance-account-heads-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Level" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Account Heads')
          <a href="{{ url('finance-and-management/finance-account-heads/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Level Four List</a></li>
</ul>
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                 ...
                 @can('Edit Account Heads')
                  <th class="wd-5p">Edit</th>
                  @endcan
                  @can('Delete Account Heads')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('account_heads.datatable') }}',
          'type': 'POST',
          'headers': {
