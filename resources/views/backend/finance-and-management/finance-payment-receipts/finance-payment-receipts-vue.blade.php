...
<div class="br-pagebody">
  ...
  <!--  <a href="{{ url('finance-and-management/finance-payment-receipts') }}">
<button type="button" title="Old Payment Receipts" class="btn btn-warning btn-sm hidden-print">OLD PAYMENT REC.</button>
</a> -->
