...
@section('page-content')
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Accounts Trial Balance</h6>
...
<button type="button" onclick="window.print()" title="Print"
    ...
    <ul class="breadcrumbee border-bottom-custom">
                    ...
                    <li><a href="{{url()->current()}}">Accounts Trial Balance List</a></li>
    </ul>
...
<div id="app">
         <acctrialbalancedt></acctrialbalancedt>
</div>
