...
@section('page-content')
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Member / Guest Trial Balance</h6>
        <div class="hidden-print" style="text-align: right; margin-top: -39px;">
<!-- 
            <a href="{{ url('finance-and-management/member-guest-trial-balance') }}">
<button type="button" title="Old Trial Balance" class="btn btn-warning btn-sm hidden-print">OLD TRIAL BALANCE</button>
</a> -->
<button type="button" onclick="window.print()" title="Print"
    ...
    <ul class="breadcrumbee border-bottom-custom">
                    ...
                    <li><a href="{{url()->current()}}">Member / Guest Trial Balance List</a></li>
    </ul>
