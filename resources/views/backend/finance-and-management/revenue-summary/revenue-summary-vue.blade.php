...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Revenue Summary (Section-Wise)</h6>
...
<button type="button" onclick="window.print()" title="Print"
 ...
 <ul class="breadcrumbee border-bottom-custom">
         ...
         <li><a href="{{url()->current()}}">Revenue Summary Report</a></li>
    </ul>
