...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Reinstating Fee</h6>
...
<button type="button" onclick="window.print()" title="Print"
  ...
  <li><a href>Reinstating Fee List</a></li>
</ul>
...
<div id="app">
         ...
         <reinstatingfeedt :csrf="'{{csrf_token()}}'"></reinstatingfeedt>
