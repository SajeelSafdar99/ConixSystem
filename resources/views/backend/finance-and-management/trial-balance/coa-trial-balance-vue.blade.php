...
@section('page-content')
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">COA Trial Balance</h6>
               ...
               <a href="{{url()->current()}}">
                ...
                <ul class="breadcrumbee border-bottom-custom">
                   ...
                   <li><a href="{{ url('finance-and-management/finance-reports-submodules') }}">Reports</a></li>
                    ...
                    <li><a href="{{url()->current()}}">COA Trial Balance</a></li>
                </ul>
...
<div id="app">
         <coatrialbalancedt></coatrialbalancedt>
</div>
