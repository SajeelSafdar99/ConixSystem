...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Account Types')
          <a href="{{ url('finance-and-management/finance-account-types/finance-account-types-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Level" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Account Types')
          <a href="{{ url('finance-and-management/finance-account-types/deleted') }}">
...
<li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href>Level Five List</a></li>
</ul>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('account_types.datatable') }}',
          'type': 'POST',
          'headers': {
