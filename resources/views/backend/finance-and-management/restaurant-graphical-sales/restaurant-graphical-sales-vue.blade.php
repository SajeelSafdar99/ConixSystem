...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">RESTAURANT-WISE GRAPHICAL SALES REPORT</h6>
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/food-and-beverage/reports') }}">Food & Beverage Reports</a></li>
     <li><a href="{{ url('finance-and-management/food-and-beverage/reports/graphs-and-charts') }}">Graphs & Charts</a></li>
    <li><a href>Restaurant-Wise Graphical Sales</a></li>
    </ul>          
...
<div id="app">
         ...
         <restaurantgraphicalsales></restaurantgraphicalsales>
