...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Ledger Persons')
          <a href="{{ url('finance-and-management/suppliers/suppliers-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Ledger Account" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Ledger Persons')
          <a href="{{ url('finance-and-management/suppliers/deleted') }}">
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('ledgerperson.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            {data: 'person_no', name: 'person_no', searchable: true},
            {data: 'person_name', name: 'person_name', searchable: true},
            {data: 'person_address', name: 'person_address', searchable: true},
            {data: 'person_cnic', name: 'person_cnic', searchable: true},
            {data: 'person_contact', name: 'person_contact', searchable: true},
            {data: 'person_email', name: 'person_email', searchable: true},
            @can('Edit Ledger Persons')
