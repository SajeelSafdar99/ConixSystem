...
<div class="br-pagebody">
        <div>
          ...
          @can('Add Level Two')
          <a href="{{ url('finance-and-management/finance-level-two/finance-level-two-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Level" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Level Two')
          <a href="{{ url('finance-and-management/finance-level-two/deleted') }}">
