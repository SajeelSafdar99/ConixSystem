...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Sales Summary (With Items)</h6>
...
<button type="button" onclick="window.print()" title="Print"
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/food-and-beverage/reports/sale-reports') }}">Sale Reports</a></li>
    <li><a href>Sales Summary (With Items)</a></li>
    </ul>          
...
<div id="app">
         <itemssalessummary></itemssalessummary>
</div>
