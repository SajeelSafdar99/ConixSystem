...
<div class="br-pagebody">
        <div>
          ...
          @can('Add General Voucher')
          <a href="{{ url('finance-and-management/finance-voucher/finance-voucher-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New General Voucher" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted General Vouchers')
          <a href="{{ url('finance-and-management/finance-voucher/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
 ...
 <li><a href="{{ url('finance-and-management') }}">Finance Management</a></li>
  <li><a href="{{ url('finance-and-management/finance-vouchers-submodules') }}">General Vouchers</a></li>
  <li><a href>General Vouchers List</a></li>
</ul>
 @if($errors->any())
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">Credit</th>
                   @can('Post and Unpost Voucher')
                  <th class="wd-15p">Status</th>
                   @endcan
                    @can('View General Voucher Documents')
                  <th class="wd-15p hidden-print">Doc.</th>
                  @endcan
                   @can('Print General Voucher')
                  <th class="wd-10p hidden-print">Voucher</th>
                  @endcan
                   @can('Edit General Voucher')
                  <th class="wd-10p hidden-print">Edit</th>
                  @endcan
                   @can('Delete General Voucher')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'desc' ]],
          "ajax": {
          'url': '{{ route('general_voucher.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [
           ...
           {width: '1%',data: 'voucher_type', name: 'voucher_type', searchable: true},
            ...
            {width: '1%',data: 'credit_amount', name: 'credit_amount', searchable: false},
             ...
             @can('Post and Unpost Voucher')
            {width: '1%',data: 'status', name: 'status', orderable:false},
            @endcan

             @can('View General Voucher Documents')
             {width: '0.5%',data: 'docs', name: 'docs', orderable:false},
             @endcan
            
            @can('Print General Voucher')
             {width: '0.5%',data: 'invoice', name: 'invoice', orderable:false},
             @endcan
