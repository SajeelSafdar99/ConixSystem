...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Monthly Maintenance Fee</h6>
...
<button type="button" onclick="window.print()" title="Print"
  ...
  <li><a href>Monthly Maintenance Fee List</a></li>
</ul>
...
<div id="app">
         ...
         <maintenancefeedt :csrf="'{{csrf_token()}}'"></maintenancefeedt>
