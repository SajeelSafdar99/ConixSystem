        ...
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Books</h6>
           <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            @can('Add Books')
          <a href="{{ url('finance-and-management/books/books-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Book" height="28" width="28" border="0/">
          </a>
          @endcan 
          @can('View Deleted Books')
          <a href="{{ url('finance-and-management/books/deleted') }}">
