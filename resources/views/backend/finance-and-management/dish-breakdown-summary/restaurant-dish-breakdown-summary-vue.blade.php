...
.headingsetting{
 ...
 table.myFormat tr th { font-size: 14px !important; }
...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Dish Breakdown Summary (Restaurant-Wise)</h6>
...
<button type="button" onclick="window.print()" title="Print"
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/food-and-beverage/reports/dish-breakdown-reports') }}">Dish Breakdown Summaries</a></li>
    <li><a href>Restaurant Summary</a></li>
    </ul>          
...
<div id="app">
         ...
         <restaurantdishbreakdown></restaurantdishbreakdown>
