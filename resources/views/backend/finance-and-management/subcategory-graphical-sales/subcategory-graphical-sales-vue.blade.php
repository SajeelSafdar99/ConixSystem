...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">SUBCATEGORY-WISE GRAPHICAL SALES REPORT</h6>
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href>Subcategory-Wise Graphical Sales</a></li>
    </ul>          
...
<div id="app">
         ...
         <subcatgraphicalsales></subcatgraphicalsales>
