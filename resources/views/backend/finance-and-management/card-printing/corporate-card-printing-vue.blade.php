...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Corporate Card Printing</h6>
...
<button type="button" onclick="window.print()" title="Print"
  ...
  <li><a href>Corporate Card Printing List</a></li>
</ul>
...
<div id="app">
         ...
         <corporatecardprintingdt :csrf="'{{csrf_token()}}'"></corporatecardprintingdt>
