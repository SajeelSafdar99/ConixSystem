...
.select2-selection__placeholder {
  color: #c4c4c4 !important; 
    ...
    <div class="br-pagebody">
        <div>
            <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10  hidden-print margara">Maintenance Fee Revenue</h6>
 ...
 <ul class="breadcrumbee border-bottom-custom">
    ...
    <li><a href="{{ url('finance-and-management/reports/maintenance-fee-revenue') }}">Maintenance Fee Revenue List</a></li>
    </ul>
...
<div class="col-md-2">
     ...
     <div class="header"><b>MAINTENANCE FEE REVENUE DETAILS</b></div>
                ...
                <div class="table-wrapper">
                    <table id="usersTable2" class="table display nowrap">
                        ...
                        <tr>
                            ...
                            <th class="wd-10p">Maintenance Fee</th>
