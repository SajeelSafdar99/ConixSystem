...
<div class="br-pagebody">
        <div>
         ...
         <div style="text-align: right;" class="hidden-print">
           ...
           @can('Add Finance Cash Receipt')
           <a href="{{ url('finance-and-management/finance-cash-receipts/finance-cash-receipts-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Cash Receipt" height="28" width="28" border="0/">
          </a>
          @endcan

          @can('View Deleted Finance Cash Receipts')
          <a href="{{ url('finance-and-management/finance-cash-receipts/deleted') }}">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Payment Method</th>
                   ...
                   @can('Print Finance Cash Receipt')
                  <th class="wd-10p hidden-print">Invoice</th>
                  @endcan
                   @can('Edit Finance Cash Receipt')
                  <th class="wd-5p hidden-print">Edit</th>
                  @endcan
                   @can('Delete Finance Cash Receipt')
