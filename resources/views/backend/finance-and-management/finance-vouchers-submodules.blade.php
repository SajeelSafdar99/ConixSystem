...
{{-- Main Nav Bar --}}
    ...
    <h3 style="text-align: center; color: black;">VOUCHERS</h3>
    </div>
      ...
      <div class="col-sm-3">
          <a href="{{ url('finance-and-management/finance-vouchers-submodules/definitions') }}">
...
<a href="{{ url('finance-and-management/finance-payment-receipts-vue') }}">
 ...
 <div class="divwidthset">
          ...
          <div class="col-sm-3">
<a href="{{ url('finance-and-management/finance-voucher') }}">
            <div class="col-sm-6 col-xl-12 flip-box cursorpointer">
             <div class="flip-box-inner">
            <div class="pd-25 d-flex align-items-center maindivbg">
                  
                  <img src="{{ url('assets/images/finance-and-management/vouchers.png') }}">
                  <div class="divwidthset">
                   <p class=" mg-b-2 lh-1 icon-below">  <b  class="icontexts">&nbsp&nbsp&nbsp&nbspGENERAL VOUCHERS</b></p></div>
