...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Chart of Accounts</h6>
 ...
 <li><a href="{{ url('/') }}">Home</a></li>
  ...
  <li><a href="{{ url('COA-new') }}">COA</a></li>
   <li><a href>Deleted Accounts</a></li>
</ul>        
      @if($errors->any())
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('coa_deleted.datatable') }}',
          'type': 'POST',
          'headers': {
