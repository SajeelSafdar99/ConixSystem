...
<span class="middiv widthclass"><strong>{{$profiledata->company_name}}</strong> <br>
  ...
  <span class="float-right"> <h1>INVOICE<br><br>(unpaid)</h1></span>
...
<thead>
 ...
 @endphp
  ...
  @if($sub->grand_total-$sub->amount_paid>0)
...
<td class="left">{{ $sub->grand_total }}</td>
 ...
 @php $sumofgrandtotal += $sub->grand_total; @endphp
  @php $sumofamt += $sub->amount_paid; @endphp
@endif
@endforeach
...
<td class="right">
<strong>{{$sumofgrandtotal-$sumofamt}}</strong>
</td>
</tr>  
