...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Sports Subscriptions</h6>
...
<button type="button" onclick="window.print()" title="Print"
  ...
  <li><a href>Sports Subscriptions List</a></li>
</ul>
...
<div id="app">
         ...
         <subscriptionsdt :csrf="'{{csrf_token()}}'"></subscriptionsdt>
