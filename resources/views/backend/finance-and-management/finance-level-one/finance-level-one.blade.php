...
<div class="br-pagebody">
        ...
        <div class="hidden-print" style="text-align: right; margin-top: -39px;">
          @can('Add Level One')
          <a href="{{ url('finance-and-management/finance-level-one/finance-level-one-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Level" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Level One')
          <a href="{{ url('finance-and-management/finance-level-one/deleted') }}">
