...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Currency Definitions</h6>
            ...
            @can('Add Currency Definition')
          <a href="{{ url('food-and-beverage/currency-definitions/currency-definitions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Currency Definition" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Currency Definitions')
          <a href="{{ url('food-and-beverage/currency-definitions/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Currency Definitions List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Currency Definition')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Currency Definition')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('currency_defs.datatable') }}',
          'type': 'POST',
          'headers': {
