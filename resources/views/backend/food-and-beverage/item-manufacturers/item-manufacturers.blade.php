...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Item Manufacturers</h6>
            ...
            @can('Add Item Manufacturer')
          <a href="{{ url('food-and-beverage/item-manufacturers/item-manufacturers-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Item Manufacturer" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Item Manufacturers')
          <a href="{{ url('food-and-beverage/item-manufacturers/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Item Manufacturers List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Item Manufacturer')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Item Manufacturer')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('manufacturers.datatable') }}',
          'type': 'POST',
          'headers': {
