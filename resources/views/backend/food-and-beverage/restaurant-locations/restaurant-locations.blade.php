...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Restaurant Locations</h6>
            ...
            @can('Add Restaurant Location')
          <a href="{{ url('food-and-beverage/restaurant-locations/restaurant-locations-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Restaurant Location" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Restaurant Locations')
          <a href="{{ url('food-and-beverage/restaurant-locations/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Restaurant Locations List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Restaurant Location')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Restaurant Location')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('restaurant_locations.datatable') }}',
          'type': 'POST',
          'headers': {
