        ...
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">ENT Details</h6>
           <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            @can('Add ENT Details')
          <a href="{{ url('food-and-beverage/ent-details/ent-details-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New ENT" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted ENT Details')
          <a href="{{ url('food-and-beverage/ent-details/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>ENT Details List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit ENT Details')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete ENT Details')
