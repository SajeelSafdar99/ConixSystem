...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Cake Types</h6>
            ...
            @can('Add Cake Types')
          <a href="{{ url('food-and-beverage/cake-types/cake-types-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Cake Type" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Cake Types')
          <a href="{{ url('food-and-beverage/cake-types/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Cake Types List</a></li>
</ul>            
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('cake_types.datatable') }}',
          'type': 'POST',
          'headers': {
