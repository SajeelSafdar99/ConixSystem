...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Product Classifications</h6>
            ...
            @can('Add Product Classification')
          <a href="{{ url('food-and-beverage/product-classifications/product-classifications-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Product Classification" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Product Classifications')
          <a href="{{ url('food-and-beverage/product-classifications/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Product Classifications List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Product Classification')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Product Classification')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('product_class.datatable') }}',
          'type': 'POST',
          'headers': {
