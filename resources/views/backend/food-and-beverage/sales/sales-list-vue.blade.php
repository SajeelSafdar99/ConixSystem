...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara" >Sales List</h6>
             <div class="hidden-print" style="text-align: right; margin-top: -39px;">
          <!--    <a href="{{ url('food-and-beverage/sales') }}">
<button type="button" title="Old Sales" class="btn btn-warning btn-sm hidden-print">OLD SALES</button>
</a> -->
