...
<div class="br-pagebody">
        <div>
          ...
          <div style="text-align: right;">
            @can('Add Printers')
          <a href="{{ url('food-and-beverage/printers/printers-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Printer" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Printers')
          <a href="{{ url('food-and-beverage/printers/deleted') }}">
...
// $(document).ready(function() {
        ...
        columns: [   
            ...
            {data: 'desc', name: 'desc', searchable: true},
             {data: 'api', name: 'api', searchable: true},
