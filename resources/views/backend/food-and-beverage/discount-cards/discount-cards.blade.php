...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Discount Cards</h6>
            ...
            @can('Add Discount Card')
          <a href="{{ url('food-and-beverage/discount-cards/discount-cards-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Discount Card" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Discount Cards')
          <a href="{{ url('food-and-beverage/discount-cards/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Discount Cards List</a></li>
</ul>            
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('discount_card.datatable') }}',
          'type': 'POST',
          'headers': {
        ...
        columns: [   
            ...
            {data: 'card_number', name: 'card_number', searchable: true},
            {data: 'card_issue_date', name: 'card_issue_date', searchable: true},
            {data: 'card_expiry_date', name: 'card_expiry_date', searchable: true},
             {data: 'discount_amount', name: 'discount_amount', searchable: true},
              {data: 'pct', name: 'pct', searchable: true},
