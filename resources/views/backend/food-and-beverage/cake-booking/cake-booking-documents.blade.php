...
<div class="br-pagebody">
          ...
          <h5 class="tx-gray-800 tx-uppercase tx-bold tx-18 mg-b-10" style="text-align: center;">CAKE BOOKING DOCUMENTS<br>(BOOKING #: {{$receiptdata->booking_no}})</h5>
...
@if($receiptdata->type==0)

    @foreach($receiptdata->CakeBookingDocs->pluck('url') as $image)
