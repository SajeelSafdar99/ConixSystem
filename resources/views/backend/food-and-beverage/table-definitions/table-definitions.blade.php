...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Table Definitions</h6>
            ...
            @can('Add Table Definition')
          <a href="{{ url('food-and-beverage/table-definitions/table-definitions-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Table Definition" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Table Definitions')
          <a href="{{ url('food-and-beverage/table-definitions/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Table Definitions List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Table</th>
                  <th class="wd-10p">Status</th>
                  @can('Edit Table Definition')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Table Definition')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('table_defs.datatable') }}',
          'type': 'POST',
          'headers': {
