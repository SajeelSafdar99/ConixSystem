...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Cancelled Item Remarks</h6>
            ...
            @can('Add Cancelled Item Remark')
          <a href="{{ url('food-and-beverage/cancelled-item-remarks/cancelled-item-remarks-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Remark" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Cancelled Item Remarks')
          <a href="{{ url('food-and-beverage/cancelled-item-remarks/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Cancelled Item Remarks List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Cancelled Item Remark')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Cancelled Item Remark')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('cancelled_remark.datatable') }}',
          'type': 'POST',
          'headers': {
