...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Delivery Riders</h6>
            ...
            @can('Add Delivery Rider')
          <a href="{{ url('food-and-beverage/delivery-riders/delivery-riders-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Delivery Rider" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Delivery Riders')
          <a href="{{ url('food-and-beverage/delivery-riders/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Delivery Riders List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Delivery Rider')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Delivery Rider')
