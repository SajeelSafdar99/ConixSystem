...
<div class="br-pagebody">
        <div>
          ...
          <a href="{{ url('food-and-beverage/item-categories/item-categories-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Item Category" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Item Categories')
          <a href="{{ url('food-and-beverage/item-categories/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Item Categories List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th class="wd-10p">First Printer</th>
                  <th class="wd-10p">Second Printer</th>
        ...
        columns: [   
            ...
            {data: 'desc', name: 'desc', searchable: true},
              {data: 'printer', name: 'printer', searchable: true},
               {data: 'printer_two', name: 'printer_two', searchable: true},
