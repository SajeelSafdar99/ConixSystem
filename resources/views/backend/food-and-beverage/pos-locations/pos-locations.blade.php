        ...
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">POS Locations</h6>
           <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            @can('Add POS Location')
          <a href="{{ url('food-and-beverage/pos-locations/pos-locations-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New POS Location" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted POS Locations')
          <a href="{{ url('food-and-beverage/pos-locations/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>POS Locations List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit POS Location')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete POS Location')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('pos_locations.datatable') }}',
          'type': 'POST',
          'headers': {
