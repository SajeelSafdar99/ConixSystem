...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Member Occupation</h6>
            ...
            @can('Add Member Occupation')
          <a href="{{ url('club-hospitality/member-occupations/member-occupations-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Member Occupation" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Member Occupations')
          <a href="{{ url('club-hospitality/member-occupations/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Member Occupation List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Member Occupation')
                  <th class="wd-10p">Edit</th>
                  @endcan
                   @can('Delete Member Occupation')
...
<script type="text/javascript">
  var oTable = '';
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('member_occupation.datatable') }}',
          'type': 'POST',
          'headers': {
