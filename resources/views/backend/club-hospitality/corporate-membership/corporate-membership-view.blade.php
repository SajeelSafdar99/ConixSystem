...
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  ...
  <li><a href>View Corporate Membership</a></li>
</ul>
...
<br><br>
 ...
 <div class="col-sm-6">
    <br>
             ...
             <input @if($errors->has('kinship_name')) style="border-color:red;"  @endif id="kinship_name" class="form-control input-height typeahead" readonly placeholder="Enter to Search..." autocomplete="off" value="@if($init==0){{old('kinship_name')}}@else{{old('kinship_name',$varkinship)}}@endif"
                                                               type="text" name="kinship_name"
  ...
  <div class="row mg-t-10">
                        ...
                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                              <select @if ($errors->has('corporate_company')) style="border-color:red;" @endif id="corporate_company" class="form-control" name="corporate_company"  disabled="true">
...
<div class="col-sm-6">
 ...
 <div class="row">
    ...
    <a href="{{ url('club-hospitality/corporate-membership-vue') }}" class="btn btn-secondary">Back</a>
    </div>
  </div>
    </div>
    </div>
