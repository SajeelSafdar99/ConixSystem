...
<ul class="breadcrumbee mg-b-25  border-bottom-custom">
  ...
  <li><a href="{{ url('club-hospitality/corporate-membership-vue') }}">CorporateMemberships List</a></li>
  <li><a href>Corporate Membership Documents</a></li>
</ul>
@else
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  <li><a href="{{ url('/') }}">Home</a></li>
...
@if($init==1)
 ...
 @endcan
  ...
  <button class="w3-bar-item w3-button  w3-red theactiveclass" onclick="location.href='{{ url('club-hospitality/corporate-membership/corporate-membership-docs-aeu/') }}/{{Request::segment(4)}}' ">Membership Documents</button>
