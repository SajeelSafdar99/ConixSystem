...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Member Title</h6>
            ...
            @can('Add Member Title')
          <a href="{{ url('club-hospitality/member-title/member-title-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Member Title" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Member Title')
          <a href="{{ url('club-hospitality/member-title/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Member Titles List</a></li>
</ul>            
            ...
            <table class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  @can('Edit Member Title')
                  <th class="wd-10p">Edit</th>
                  @endcan
                   @can('Delete Member Title')
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('member_title.datatable') }}',
          'type': 'POST',
          'headers': {
