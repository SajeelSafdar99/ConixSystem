...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Membership Category</h6>
             ...
             @can('Add Membership Category')
          <a href="{{ url('club-hospitality/member-category/member-category-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Member Category" height="28" width="28" border="0/">
          </a>
            @endcan
            @can('View Deleted Membership Categories')
          <a href="{{ url('club-hospitality/member-category/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Membership Category List</a></li>
</ul>                
            ...
            <table class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Subscription Fee</th>
                  <th class="wd-15p">Status</th>
                  @can('Edit Membership Category')
                  <th class="wd-15p">Edit</th>
                  @endcan
                   @can('Delete Membership Category')
...
// $(document).ready(function() {
        ...
        columns: [   
          ...
          //   },
            ...
            {data: 'unique_code', name: 'unique_code', searchable: true},
            {data: 'desc', name: 'desc', searchable: true},
            {data: 'fee', name: 'fee', searchable: true},
            {data: 'monthly_sub_fee', name: 'monthly_sub_fee', searchable: true},
