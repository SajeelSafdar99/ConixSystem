...
<div class="br-pagebody">
        <div>
          ...
          <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            @can('Add Member Type')
          <a href="{{ url('club-hospitality/member-classification/member-classification-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Member Classification" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Member Types')
          <a href="{{ url('club-hospitality/member-classification/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Member Type List</a></li>
</ul>            
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('classification.datatable') }}',
          'type': 'POST',
          'headers': {
