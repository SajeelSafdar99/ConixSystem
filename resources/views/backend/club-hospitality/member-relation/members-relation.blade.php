...
<div class="br-pagebody">
        <div>
          ...
          <div class="hidden-print" style="text-align: right; margin-top: -39px;">
           @can('Add Member Relations')
          <a href="{{ url('club-hospitality/member-relation/members-relation-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Member Relation" height="28" width="28" border="0/">
          </a>
          @can('View Deleted Member Relations')
          <a href="{{ url('club-hospitality/member-relation/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Member Relations List</a></li>
</ul> 
            ...
            <table  class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  @can('Edit Member Relations')
                  <th class="wd-15p">Edit</th>
                  @endcan
                   @can('Delete Member Relations')
