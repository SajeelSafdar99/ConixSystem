...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Family Memberships</h6>
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href="{{url()->current()}}">Family Memberships List</a></li>
</ul>
 @if($errors->any())
...
<div id="app">
         <familymembershipdt></familymembershipdt>
</div>
