...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Corporate Companies</h6>
             ...
             @can('Add Corporate Companies')
          <a href="{{ url('club-hospitality/corporate-companies/corporate-companies-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Company" height="28" width="28" border="0/">
          </a>
            @endcan
            @can('View Deleted Corporate Companies')
          <a href="{{ url('club-hospitality/corporate-companies/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Corporate Companies List</a></li>
</ul>                
            ...
            <table class="table display nowrap datatable">
              ...
              <thead>
                <tr>
                  ...
                  @can('Edit Corporate Companies')
                  <th class="wd-5p">Edit</th>
                  @endcan
                   @can('Delete Corporate Companies')
...
// $(document).ready(function() {
        ...
        columns: [   
          ...
          //   },
            ...
            {data: 'company_logo', name: 'company_logo', searchable: false,orderable: false},
             @can('Edit Corporate Companies')
