...
<div class="br-pagebody">
      ...
      <div class="hidden-print" style="text-align: right; margin-top: -39px;">
            <!-- 
              <a href="{{ url('finance-and-management/reports/maintenance-report') }}">
<button type="button" title="Old Quarterly Maintenance Report" class="btn btn-warning btn-sm hidden-print">OLD MAINTENANCE REPORT</button>
</a> -->
          <a href>
...
<div id="app">
         ...
         <quarterlymaintenancedt></quarterlymaintenancedt>
