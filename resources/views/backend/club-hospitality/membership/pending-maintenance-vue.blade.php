...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Pending Maintenance Report</h6>
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Pending Maintenance Report</a></li>
</ul>
 @if($errors->any())
...
<div id="app">
         ...
         <pendingmaintenancedt :csrf="'{{csrf_token()}}'"></pendingmaintenancedt>
