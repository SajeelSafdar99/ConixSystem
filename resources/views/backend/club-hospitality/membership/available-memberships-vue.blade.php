...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara hidden-print">Available Membership Numbers</h6>
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Available Membership Numbers</a></li>
</ul>
 @if($errors->any())
