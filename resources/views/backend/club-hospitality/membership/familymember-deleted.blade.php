...
<ul class="breadcrumbee mg-b-25 border-bottom-custom">
  ...
  <li><a href="{{ url('club-hospitality/membership-vue') }}">Memberships List</a></li>
   <li><a href="{{ url('club-hospitality/membership/familymember-aeu') }}/{{Request::segment(4)}}">Family Members List</a></li>
  <li><a href>Deleted Family Members</a></li>
</ul>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('familymember_deleted.datatable',$membershipdata->id) }}',
          'type': 'POST',
          'headers': {
