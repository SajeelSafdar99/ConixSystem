...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Subscriptions & Maintenance Summary (Category-Wise)</h6>
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Subscriptions & Maintenance Summary (Category-Wise)</a></li>
</ul>
 @if($errors->any())
...
<div id="app">
         ...
         <catsubscriptionsummary></catsubscriptionsummary>
