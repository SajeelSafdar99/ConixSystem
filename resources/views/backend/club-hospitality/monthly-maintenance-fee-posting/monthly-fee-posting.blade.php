...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10">Members Monthly Maintenance</h6>
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Members Monthly Maintenance List</a></li>
</ul> 
            ...
            <table  class="table display nowrap datatable">
              <thead>
                <tr>
                  ...
                  <th class="wd-15p">Membership Number</th>
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('maintenance.datatable') }}',
          'type': 'POST',
          'headers': {
