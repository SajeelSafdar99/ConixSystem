...
<div class="br-pagebody">
        <div>
          <h6 class="tx-gray-800 tx-uppercase tx-bold tx-14 mg-b-10 margara">Membership Status</h6>
            ...
            @can('Add Membership Status')
          <a href="{{ url('club-hospitality/membership-status/membership-status-aeu') }}">
          <img src="{{ url('assets/images/addnew.png') }}" title="Add New Membership Status" height="28" width="28" border="0/">
          </a>
          @endcan
          @can('View Deleted Membership Status')
          <a href="{{ url('club-hospitality/membership-status/deleted') }}">
...
<ul class="breadcrumbee border-bottom-custom">
  ...
  <li><a href>Membership Status List</a></li>
</ul>            
...
// $(document).ready(function() {
        ...
        sProcessing: "<img src='{{ url('assets/images/geargif.gif') }}'>"
          ...
          order: [[ 1, 'asc' ]],
          "ajax": {
          'url': '{{ route('membership_status.datatable') }}',
          'type': 'POST',
          'headers': {
