...
<div class="col-sm-3">
<a href="{{ url('sports-subscription/sports') }}">
             <div class="col-sm-6 col-xl-12 flip-box cursorpointer" >
             <div class="flip-box-inner">
            <div class="pd-25 d-flex align-items-center maindivbg">
               
                  
                  <img src="{{ url('assets/images/sports-subscription/sports.png') }}">
<div class="divwidthset">
                   <p class=" mg-b-2 lh-1 icon-below">   <b class="icontexts">&nbsp&nbsp&nbsp&nbspSUBSCRIPTION TYPES</b></p></div>
...
<div class="col-sm-3">
<a href="{{ url('sports-subscription/club-facilities') }}">
          <div class="col-sm-6 col-xl-12 flip-box cursorpointer">
            <div class="flip-box-inner">
            <div class="pd-25 d-flex align-items-center maindivbg">
            
                 
                  <img src="{{ url('assets/images/sports-subscription/club facility.png') }}">

                  <div class="divwidthset">
                   <p class=" mg-b-2 lh-1 icon-below">   <b class="icontexts">&nbsp&nbsp&nbsp&nbspCLUB FACILITIES</b></p></div>
