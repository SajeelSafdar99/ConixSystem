            ...
            <div>
                <table class="table-striped table-bordered table-hover ">
                    ...
                    <tr>
                        ...
                        <th class="wd-10p">CALL STATUS</th>
                        <th class="wd-20p">FOLLOW UP DATE</th>
                    </tr>
                    </thead>
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                     ...
                     return x;
                        ...
                        <td>{{tr.username}}</td>
                        <td>{{tr.status}}</td>
                        <template v-if="tr.follow_up && tr.follow_up!='0000-00-00 00:00:00'"><td>{{moment(tr.follow_up,"YYYY-MM-DD HH:mm:ss").format('DD/MM/YYYY HH:mm:ss')}}</td></template>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/crm/follow-ups/followups_init_vue').then(result=>{
