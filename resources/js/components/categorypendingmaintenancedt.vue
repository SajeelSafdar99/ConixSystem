        ...
        <p><strong>( Date = {{this.start_date | moment("DD/MM/YYYY")}}, Category = {{this.pluck(this.category,'name')}}, Status = {{this.pluck(this.memstatus,'name')}} )</strong></p>
            ...
            <table class="table-striped table-bordered table-hover ">
                ...
                <tr>
                    ...
                    <th style="background-color: #c7a953" class="thds">4 QUARTERS PENDING</th>
                    <th style="background-color: #e6d137" class="thds">5 QUARTERS PENDING</th>
                    <th style="background-color: #9d8cb3" class="thds">6 QUARTERS PENDING</th>
                    <th style="background-color: #73b19a" class="thds">MORE THAN 6 QUARTERS PENDING</th>
                ...
                <tr v-for="(tr,key) in
                    ...
                    <td>{{tr.q5}}
                        <span v-on:click="updatesdata(tr,5)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                    <td>{{tr.q6}}
                        <span v-on:click="updatesdata(tr,6)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                    <td>{{tr.q7}}
                        <span v-on:click="updatesdata(tr,7)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                ...
                <tr >
                    ...
                    <td><STRONG>{{ (tq5).toLocaleString()}} ({{ (tq55).toLocaleString()}})
                        <span v-on:click="gupdatesdata(5)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <td><STRONG>{{ (tq6).toLocaleString()}} ({{ (tq66).toLocaleString()}})
                        <span v-on:click="gupdatesdata(6)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <td><STRONG>{{ (tq7).toLocaleString()}} ({{ (tq77).toLocaleString()}})
                        <span v-on:click="gupdatesdata(7)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <!--<td><STRONG>{{ttm}}</STRONG></td>-->
                    <td><STRONG></STRONG></td>
                    <td><STRONG>{{ (parseInt(tq1) + parseInt(tq2) + parseInt(tq3) + parseInt(tq4) + parseInt(tq5) + parseInt(tq6) + parseInt(tq7)).toLocaleString()}} ({{ (parseInt(tq11) + parseInt(tq22) + parseInt(tq33) + parseInt(tq44)+ parseInt(tq55)+ parseInt(tq66)+ parseInt(tq77)).toLocaleString()}})</STRONG></td>
                </tr>
                </tbody>
...
import Datepicker from 'vuejs-datepicker';
    export default {
        name: "categorypendingmaintenancedt",
        components: {
            Datepicker
        },
        props: ['csrf'],
        ...
        methods:{
            ...
            init:function () {
               ...
               if(this.status){
                ...
                this.$http.get('/finance-and-management/reports/category-pending-maintenance-report-ini?off='+((this.page-1)*this.pagelength)+x).then(result=>{
                    ...
                    let ggg=0;
                        ...
                        x.forEach(function (s,key) {
                            ...
                            eeee=eeee+(parseInt(s.tqq));
                            fff=fff+(parseInt(s.tvq));
                            ggg=ggg+(parseInt(s.tbq));
