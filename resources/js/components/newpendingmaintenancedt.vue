            ...
            <div class="col-sm">
                <div class="form-group">
                    <select class="form-control" v-model="quarter">
                        ...
                        <option :value="key" v-for="(y,key) in {1:'qt1',2:'qt2',3:'qt3',4:'More than 3 qts'}">{{y}}</option>
                    </select>
                </div>
            </div>
            <div class="col-sm">
        ...
        methods:{
            ...
            init:function () {
               ...
               let x='';
                ...
                this.$http.get('/finance-and-management/reports/new-pending-maintenance-report-ini?off=1'+x).then(result=>{
                    this.ttmo.forEach((a,b)=>{
                        this.ttmo[b]=0;
                    });
                    let data=result.data;
