                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                     ...
                     return x;
                        ...
                        <td class="hidden-print"><button class="buttoncolor" title="Restore"><a style="color:#000000;" :href="'/store-management/cancellation-remarks/restore/' + tr.id"><i class="fas fa-trash-restore"></i></a></button></td>
                    </tr>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/store-management/cancellation-remarks/indexdt_deleted').then(result=>{
