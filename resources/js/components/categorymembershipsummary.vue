                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            <div class="modal-header">
                                ...
                                <h5 class="modal-title">MEMBERSHIP SUMMARY:</h5>
                                <button type="button" class="close" @click="showModal=false">
                                    <span aria-hidden="true">&times;</span>
                                </button>
                            </div>
                            <div class="modal-body">
                                <membershipsummary :sdata="ssdata" v-if="ssdata" :key="'am'+k"></membershipsummary>
                            </div>
        ...
        <p><strong>( Date = Between {{this.start_date | moment("DD/MM/YYYY")}} To {{this.end_date | moment("DD/MM/YYYY")}}, Categories = {{this.pluck(this.category,'name')}} )</strong></p>
            ...
            <table class="table-striped table-bordered table-hover ">
                ...
                <tr v-for="(tr,key) in
                    ...
                    <td>{{ (tr.cashgross).toLocaleString()}} <span v-on:click="updatesdata(tr)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                    <td>{{ (tr.creditgross).toLocaleString()}} <span v-on:click="updatesdata(tr)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                    <td>{{ (tr.othergross).toLocaleString()}} <span v-on:click="updatesdata(tr)" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></td>
                    <td><STRONG>{{ (parseInt(tr.cashgross) + parseInt(tr.creditgross) + parseInt(tr.othergross)).toLocaleString()}}</STRONG></td>

                </tr>

                <tr >
                    <td colspan="2" style="text-align: right;"><STRONG>GRAND TOTAL:</STRONG></td>
                    <td><STRONG>{{ (tq1).toLocaleString()}} <span v-on:click="gupdatesdata()" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <td><STRONG>{{ (tq2).toLocaleString()}} <span v-on:click="gupdatesdata()" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <td><STRONG>{{ (tq3).toLocaleString()}} <span v-on:click="gupdatesdata()" style="color:white; float: right !important;"><span class="text-primary"><i class="fa fa-info-circle"></i></span></span></STRONG></td>
                    <td><STRONG>{{ (parseInt(tq1) + parseInt(tq2) + parseInt(tq3)).toLocaleString()}}</STRONG></td>
                </tr>
                </tbody>
...
import Datepicker from 'vuejs-datepicker';
    export default {
        name: "categorymembershipsummary",
        components: {
            Datepicker
        },
        props: [],
        ...
        methods:{
            ...
            init:function () {
               ...
               if(this.status){
                ...
                this.$http.get('/finance-and-management/reports/category-membership-summary-ini?off='+((this.page-1)*this.pagelength)+x).then(result=>{
