...
-->
       ...
       <!-- <div class="row">
        ...
        <div class="row">
            ...
            </div><label class="col-sm-2 form-control-label"></label>
            <div class="col-sm-10">
...
<div v-if="this.exported" class="hidden-print">
    ...
    <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
        <h5>AFOHS <br>SALES KOT REPORT </h5>
    ...
    <div class="scrollclasstable1">
        ...
        <div>
            ...
            <h2>MISSING</h2>
            <table class="myFormat table-hover " v-if="error" style="width: 100%;">
                <thead>
                <th>KOT ID</th>
                <th>SALE ID</th>
                <th>ITEM DETAILS</th>
                ...
                <template v-for="(s,key) in  missing">
                    <tr>
                        <td>
                            {{s.kot_no}}
                        </td> <td>
                        ...
                        <template v-if="s.item.category">
                        <td>
                        {{categories.filter(function(a){return a.id==s.item.category})[0].desc}}
                    </td>
                        </template>
                        <template v-else>
                            <td></td>
                        ...
                        <template v-if="s.created_by">
                        <td>
                        {{users.filter(function(a){return a.id==s.created_by})[0].name}}
                    </td>
                        </template>
                        <template v-else>
                            <td></td>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/sales-kot-report/saleskot_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
