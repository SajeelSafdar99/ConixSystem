...
<div>
    ...
    <div style="text-align: center; color: black; letter-spacing: 0.2em !important; background-color: white !important;">
        ...
        <div class="">
            <button type="button " class="btn btn-primary float-right hidden-print" @click="printing">Print </button>
        <Highcharts ref="cch" :options="chartOptions" />
...
<div class="row">
                ...
                <table style="width: 60%;" class="table-bordered table-hover table-striped">
                    ...
                    <tr>
                        ...
                        <th style="text-align: center;" class="wd-20p">ORDERS COUNT</th>
        ...
        data(){
            return{
                ...
                chartOptions:{
                        ...
                        labels: {
                            ...
                            formatter: function() {
                             let d=moment(this.value);
                              return d.format('hh')+'-'+d.add(1,'hour').format('hh A')
                            }
                        }
                    },
                    yAxis: {
                    ...
                    tooltip: {
                        formatter: function() {
                            return ' <b>' + moment(this.x).format('hh:mm A') + '</b><br><b>' + this.y + '</b>';
                        },
                        shared: true
                    },
...
data:[], pointWidth: 10,
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/hourly-sales/hourlysales_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
...
if(self.id){
    ...
    if(i.p>0){
        ...
        if(parseInt(e.target.value)>parseInt(e.target.max)){
            ...
            printing(){
                this.$refs.cch.chart.setSize(700,200, false);
                window.print()
                this.$refs.cch.chart.setSize(null,500);
