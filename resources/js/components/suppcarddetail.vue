...
<template v-if="showTable">
    ...
    <div class="row hidden-print">
        ...
        <div class="col-sm-5">
            <multiselect track-by="name" label="name" placeholder="Choose Supplementary Status" v-model="status" :multiple="true" :options="(()=>{let x=[];
            stati.forEach((a)=>{
                x.push({name:a.desc,id:a.id})
            })
            return x;
...
<br>
    ...
    <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
        <h5>AFOHS <br>SUPPLEMENTARY CARD DETAIL REPORT </h5>
    </div>
<!--
        ...
        <div>
            ...
            <table class="myFormat table-hover " style="width: 100%;">
                ...
                <tr style="border-bottom: 2px solid black;" class="head" >
                    ...
                    <td><STRONG>ISSUED SUPPLEMENTARY MEMBERS</STRONG></td>
                    <td><STRONG>PRINTED SUPPLEMENTARY MEMBERS</STRONG></td>
                    <td><STRONG>RE-PRINTED SUPPLEMENTARY MEMBERS</STRONG></td>
                </tr>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/supplementary-card-detail/summary_init_vue?1=1'+x).then(result=>{
