...
<!--        <div class="hidden-print">
        ...
        <div class="row  hidden-print">
            ...
            <!--    <div class="row">
                    ...
                    <div class="col-sm-2 mg-t-10 mg-sm-t-0">
                        <label class="rdiobox">
                            <input type="radio" name="mog" v-model="mog" value="2"><span class="pabs">Supp</span>
                        </label>
                    </div>
                    <div class="col-sm-2 mg-t-10 mg-sm-t-0">
                        <label class="rdiobox">
            ...
            <div class="col-lg">
                <p style="color: black;">Payment No.</p>
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                     ...
                     return x;
                        ...
                        <template v-else-if="tr.person_id!=null">
                            <td>{{tr.person}}</td>
                        </template>
                       ...
                       <!-- <td>{{tr.headType}}-{{tr.accType}}</td>-->
                        <td>{{tr.payment_method}}</td>
                        <td>{{(parseInt(tr.total)) | numFormat }}</td>
                        <td>{{tr.cashiername}}</td>
                        <td class="hidden-print"><button class="buttoncolor" title="Print Invoice"><a style="color:#000000;" target="_blank" :href="'/finance-and-management/finance-payment-receipts/finance-payment-receipts-invoice/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td>
                        <td class="hidden-print"><button class="buttoncolor" title="Edit"><a style="color:#000000;" target="_blank" :href="'/finance-and-management/finance-payment-receipts/finance-payment-receipts-aeu/' + tr.id"><i class="fas fa-edit"></i></a></button></td>
                ...
                <ul class="pagination">
                    ...
                    <li>
                        <select  v-model="pagelength" class="">
                            ...
                            <option :value="paymentrecs.length" >ALL</option>
                        </select>
                    </li>  </ul>
                </div>
            </div>
...
export default {
    ...
    computed: {
        totals() {
            let  x=this.filterData(this.paymentrecs);
    ...
    methods:{
        ...
        afterdel:function(){
            ...
            let url='/finance-and-management/finance-payment-receipts/delete/'+this.deletethisid;
...
*/
        ...
        sliceP(paymentrecs){
            // console.log(123);
            this.paymentrecsM=paymentrecs;
            return  paymentrecs.slice((this.page-1)*this.pagelength,this.page*this.pagelength)
        },
        init:function () {

            this.$http.get('/finance-and-management/finance-payment-receipts/paymentrecs_init').then(result=>{
                ...
                this.paymentrecs=data.paymentrecs;
                this.paymentrecsR=data.paymentrecs;
                this.leng=data.paymentrecs.length;
        ...
        amountChange:function(k,e){
            if(parseInt(e.target.value)>parseInt(e.target.max)){
                this.paymentrecs[k].p=e.target.max;
            }
        }
        ,
