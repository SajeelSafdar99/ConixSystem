...
<div class="hidden-print">
            ...
            <export-excel
                ...
                name    = "DailyRestaurantSales.xls">
            </export-excel>
</div>
            <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
                <h5>AFOHS <br>DAILY SALES SUMMARY (RESTAURANT-WISE) </h5>
                <br>
            </div>
                    ...
                    <div>
                     ...
                     return x;
                                ...
                                <tr v-if="(key==0) || sales[key-1].cat!=s.cat">
                                    <td colspan="6" class="sub"><u style="text-transform: uppercase;">{{s.cat}}</u></td>
                                </tr>

                                    <tr>
                                        <td>&nbsp</td>
                                <td><STRONG>FOOD SALE:</STRONG></td>
                                <td class="text-right">{{s.grosssale | numFormat }}</td>
                                        <td>&nbsp</td>
                                        <td>&nbsp</td>
                                        <td>&nbsp</td>
                            </tr>
                                ...
                                <tr>
                                    <td>&nbsp</td>
                                    <td style="border-bottom: 2px solid black;"><STRONG>SALES TAX:</STRONG></td>
                                    <td style="border-bottom: 2px solid black;" class="text-right">{{s.taxx | numFormat }}</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{(s.grandd).toFixed(1) }}</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{(s.diss).toFixed(1) }}</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr>
                                    ...
                                    <td class="text-right">{{(s.cashgross).toFixed(1) }}</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                </tr>
                                ...
                                <tr >
                                    <td>&nbsp</td>
                                    <td style="border-bottom: 2px solid black;"><STRONG>CREDIT SALE:</STRONG></td>
                                    <td style="border-bottom: 2px solid black;" class="text-right">{{(s.creditgross).toFixed(1) }}</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                    <td>&nbsp</td>
                                </tr>
                            ...
                            <tr class="grandformat">
                                <td><STRONG>GRAND TOTAL:</STRONG></td>
                                <td><STRONG>FOOD SALE:</STRONG></td>
                                <td class="text-right"><STRONG>{{aa | numFormat }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            ...
                            <tr class="grandformat">
                                <td>&nbsp</td>
                                <td style="border-bottom: 2px solid black;"><STRONG>SALES TAX:</STRONG></td>
                                <td style="border-bottom: 2px solid black;" class="text-right"><STRONG>{{dd | numFormat }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            </tr>
                            ...
                            <tr class="grandformat">
                                <td>&nbsp</td>
                                <td><STRONG>TOTAL SALE:</STRONG></td>
                                <td class="text-right"><STRONG>{{(ee).toFixed(1) }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            </tr>
                            ...
                            <tr class="grandformat">
                                <td>&nbsp</td>
                                <td><STRONG>DISCOUNT:</STRONG></td>
                                <td class="text-right"><STRONG>{{(bb).toFixed(1) }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            </tr>
                            ...
                            <tr class="grandformat">
                                <td>&nbsp</td>
                                <td><STRONG>CASH SALE:</STRONG></td>
                                <td class="text-right"><STRONG>{{(ff).toFixed(1) }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            </tr>
                            ...
                            <tr class="grandformat">
                                <td>&nbsp</td>
                                <td style="border-bottom: 2px solid black;"><STRONG>CREDIT SALE:</STRONG></td>
                                <td style="border-bottom: 2px solid black;" class="text-right"><STRONG>{{(gg).toFixed(1) }}</STRONG></td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                                <td>&nbsp</td>
                            </tr>
...
table.myFormat tr.grandformat td {
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/reports/daily-restaurant-sales-summary/dailyrestsales_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
