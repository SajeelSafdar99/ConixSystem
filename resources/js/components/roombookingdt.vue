    ...
    <div class="row hidden-print">
        ...
        <div class="col-lg">
            <div>
                ...
                <datepicker v-model="start_date" :clear-button="true" placeholder="From Booking Date (dd/mm/yyyy)" format="dd/MM/yyyy" input-class="form-control" name="start_date"></datepicker>
        ...
        <div class="col-lg">
            <div>
                ...
                <datepicker v-model="end_date" :clear-button="true" placeholder="To Booking Date (dd/mm/yyyy)" format="dd/MM/yyyy" input-class="form-control" name="end_date"></datepicker>
            </div>
        </div>
            ...
            <table class="table-striped table-bordered table-hover ">
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                    ...
                    <template v-if="tr.booking_type==6">
                        <td>{{tr.nameMOCC}}</td>
                    </template>
                    <template v-else>  <td>{{tr.nameMOC}}</td> </template>
                    ...
                    <template v-else-if="tr.booking_type==6">
                    ...
                    <td><a target="_blank" :href="'/room-management/room-check-in/room-check-in-aeu/' + tr.id"><button class="btnwidth btn btn-outline-danger active btn-block mg-b-10" title="Check-In">Check In</button></a></td>
                    <td>{{tr.cashiername}}</td>
                    <td class="hidden-print"><button class="buttoncolor" title="Print Invoice"><a style="color:#000000;" target="_blank" :href="'/room-management/room-booking-invoice/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td>
                    <td class="hidden-print"><button class="buttoncolor" title="Edit"><a style="color:#000000;" target="_blank" :href="'/room-management/room-booking/room-booking-aeu/' + tr.id"><i class="fas fa-edit"></i></a></button></td>
                    <td class="hidden-print"><button class="buttoncolor" @click="deleteme(tr.id,tr.additional_notes);" title="Delete"><i class="fas fa-trash"></i></button></td>
                </tr>
                ...
                <tr>
                    ...
                    <td><strong>{{(totals.charges)}}</strong></td>
                    <td><strong>{{(totals.total_room_charges)}}</strong></td>
    ...
    export default {
        ...
        methods:{
            ...
            afterdel:function(){
                ...
                let url='/room-management/room-booking/delete/'+this.deletethisid;
...
location.reload();
            ...
            init:function () {
                this.$http.get('/room-management/room-booking/booking_ini').then(result=>{
