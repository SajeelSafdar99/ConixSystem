    ...
    <div class="row">
        <div class="col-sm-10">
            ...
            <div class="row mg-t-10">
                ...
                <label class="col-sm-1 form-control-label">Payment #:  <span class="tx-danger">  * </span>  </label>
...
-->
                ...
                <div class="col-sm-3 mg-t-10 mg-sm-t-0">
                    <input type="number" class="form-control input-height" name="ledger_amount" id="ledger_amount" v-model="ledger_amount" autocomplete="off" readonly="" style="background-color: #c1c1c1" value="">
                </div>
            ...
            <div class="row mg-t-10">
              ...
              <!--  <div class="col-sm-1 mg-t-10 mg-sm-t-0">
                    ...
                    <label v-for="gt in gts" class="rdiobox">
                        <input type="radio" name="receipt_type" v-model="receipt_type" :value="'0'+gt.id"><span class="pabs">{{gt.desc}}</span>
                        <br><br>
                    </label>

                    <label class="rdiobox">
                        <input type="radio"  name="receipt_type" v-model="receipt_type" value="2"><span class="pabs">Supplier</span>
                    </label>
                ...
                <div class="col-sm-3 mg-t-10 mg-sm-t-0">
                    <div class="form-group" v-on:keydown.up.prevent="udf(1)" v-on:keydown.down.prevent="udf(0)">
                        ...
                        <input  v-model="customer" name="name" id="name" value="" class="typeahead form-control" autocomplete="off" type="text" placeholder="Search by Supplier Name...">
                ...
                <div class="col-sm-1 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control input-height" name="person_id" id="person_id" v-model="person_id" autocomplete="off" readonly="" style="background-color: #c1c1c1" value="">
...
-->
                ...
                <div class="col-sm-1 mg-t-10 mg-sm-t-0">
                    <input type="text" class="form-control input-height" name="customer_id" id="customer_id" v-model="customer_id" autocomplete="off" readonly="" style="background-color: #c1c1c1" value="">
                </div>-->
         ...
         <!--       <label class="col-sm-1 form-control-label">Filter by type:<span class="tx-danger">  * </span>  </label>
                ...
                <div class="col-sm-2 mg-t-10 mg-sm-t-0">
                  <select class="form-control" v-model="type">
                    ...
                    <option v-if="cat_permission.indexOf(t.name+' '+t.mod_id)!=-1 || cat_permission.indexOf('Employee')!=-1 || cat_permission.indexOf('Ledger Account')!=-1" :value="t.id" v-for="t in types">
                        {{t.name}}
                    </option>
                  </select>
...
<!--                    <th>Details</th>-->
                ...
                <tbody>
                <tr v-if="(inv.trans_amount)-(inv.sum)>0 || id" v-for="(inv,key) in invoices.filter((a)=>{return (this.month==0?true:(this.month==moment(a.date).startOf('month').format('MMMM'))) && (this.company==0?true:(this.company==a.unit))  && (this.year==0?true:(this.year==moment(a.date).startOf('year').format('YYYY'))) && (type==0?true:(type==parseInt(a.trans_type))) })">
                    <td>{{key+1}}</td>
                    ...
                    <td><a :href="'/finance-and-management/finance-general-voucher/finance-general-voucher-invoice/'+inv.trans_type_id" target="_blank">{{inv.trans_type_id}}</a>
                    </td>
            ...
            <div class="row mg-t-10">
                ...
                <template v-if="this.advance==false">
                <label class="col-sm-1 form-control-label">
            ...
            <div class="float-left">
                ...
                <div class="row mg-t-10">
                    ...
                    <div class="form-layout-footer mg-t-30">
                        ...
                        &nbsp;&nbsp;
                        <a href="/finance-and-management/finance-payment-receipts-vue" class="btn btn-secondary">Cancel</a>
    ...
    export default {
        ...
        methods:{
            selectAll: function() {
                ...
                let self = this;
                this.invoices.filter((a)=>{return ((a.trans_amount)-(a.sum)>0) && (this.company==0?true:(this.company==a.unit))  && (this.month==0?true:(this.month==moment(a.date).startOf('month').format('MMMM'))) && (this.year==0?true:(this.year==moment(a.date).startOf('year').format('YYYY'))) && (this.type==0?true:(this.type==parseInt(a.trans_type)))  }).forEach(function(inv) {
                    if (!self.selectall) {
            ...
            init:function (m) {
                ...
                // console.log(m);
                this.$http.get(this.linking+'/finance-and-management/finance-payment-receipts/finance-payment-receipts-aeu/init'+r).then(result=>{
                    ...
                    if(m){
                        ...
                        this.receipt_type=data.invoice_no.person_id?22:data.invoice_no.mem_number?0:data.invoice_no.customer_id?1:3;
                        let b=this.receipt_type==22?data.invoice_no.person_id:this.receipt_type==3?data.invoice_no.employee_id:this.receipt_type==0?data.invoice_no.mem_number:this.receipt_type==1?data.invoice_no.customer_id:0
            ...
            customerdatavalue(val,m){
                ...
                this.$http.post('/search/customerdata?inv=1&paybalance=1&padvance=1&MOC='+v+r,{customerid:val}).then(result=>{
                    let data =result.data;
                    if(data){
                        this.families=[];
                        if (v == 0) {
                            ...
                            this.invoices.forEach(function(i){
                                ...
                                if(self.id){
                                    i.payment_details2.forEach(function(x){
                               ...
                               /* if(self.id){
                                    i.payments2.forEach(function(x){
                                        x.payment_details2.forEach(function(d){
                                    ...
                                    i.payments.forEach(function(x){
                                        console.log(x.payment_details);
                                        x.payment_details.forEach(function(d){
        ...
        if(parseInt(e.target.value)>parseInt(e.target.max)){
            ...
            save_invoice:function(m){
               ...
               let data={
                ...
                let url='/finance-and-management/finance-payment-receipts/finance-payment-receipts-aeu/save';
                if(m){
                    url='/finance-and-management/finance-payment-receipts/finance-payment-receipts-aeu/update';
                    data.id=this.id;
                }
                ...
                {
                    if((this.advance!=1 && !this.account)) {
                        alert('Cash / Bank is required !');
                    }
                    else if((this.advance!=1 && !this.payment_method)) {
                        ...
                        if (this.validation(data, ['invoice_date', 'customer', 'total_paid_amt', 'amount_in_words']) == 0) {
                            ...
                            this.$http.post(url, data).then(result => {
                                ...
                                window.location.href = "/finance-and-management/finance-payment-receipts-vue";
                            });
                        }
                    }
                }
                    ...
                    if((this.advance!=1 && !this.account)) {
                        ...
                        if (this.validation(data, ['invoice_date', 'customer', 'total_paid_amt', 'amount_in_words']) == 0) {
                            ...
                            this.$http.post(url, data).then(result => {
                                ...
                                location.reload();
                                if (m) {
                                    window.open("/finance-and-management/finance-payment-receipts/finance-payment-receipts-invoice/" + m, "_blank");
                                } else {
                                    window.open("/finance-and-management/finance-payment-receipts/finance-payment-receipts-invoice/" + result.data, "_blank");
                                }
                            });
                        }
                    }
...
let m=this.id;
                ...
                this.$http.post('/search/customerdata?inv=1&paybalance=1&padvance=1&MOC='+v+r,{customerid:x.get('memid')}).then(result=>{
                    let data =result.data;
                    if(data) {
                        this.alreadySearched=true;
                        this.mem_id = data.mem_no;
               ...
               console.log(x.get('memid'));
                ...
                this.$http.post('/search/customerdata?inv=1&paybalance=1&padvance=1&MOC='+v+r,{customerid:x.get('guestid')}).then(result=>{
                    let data =result.data;
                    if(data) {
                        this.alreadySearched=true;
                ...
                this.$http.post('/search/customerdata?inv=1&paybalance=1&padvance=1&MOC='+v+r,{customerid:x.get('empid')}).then(result=>{
                    let data =result.data;
                    if(data) {
                        this.alreadySearched=true;
                        this.employee_id = data.id;
                ...
                this.$http.post('/search/customerdata?inv=1&paybalance=1&padvance=1&MOC='+v+r,{customerid:x.get('accid')}).then(result=>{
                    let data =result.data;
                    if(data) {
                        this.alreadySearched=true;
                        this.person_id = data.id;
