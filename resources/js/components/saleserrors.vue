                    ...
                    <div>
                     ...
                     return x;
                                ...
                                <tr v-if="sales[(key+((page-1)*pagelength))+1]==undefined ||  sales[(key+((page-1)*pagelength))+1].cat!=s.cat">
                                    ...
                                    <td></td>
                                   <!-- <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{s.sub}} TOTAL:</STRONG></td>-->
                            ...
                            <tr style="border: 2px solid black;" v-if="!fFilter">
                                <td></td>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/reports/sales-errors/saleserrors_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
                ...
                if(this.getRe){
                    ...
                    x.forEach(function (s,key) {
                        ...
                        aaa=aaa+parseFloat(s.sale_price3);
