            ...
            <table class="table-striped table-bordered table-hover ">
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                    ...
                    <td><a target="_blank" :href="'/club-hospitality/membership/familymember-aeu/' + tr.id">{{tr.famcount}}</a></td>
...
<template v-if="tr.activestatus=='Active' || tr.activestatus=='active' || tr.activestatus=='ACTIVE'">
    <td><button class="btnwidth btn btn-outline-success active btn-block mg-b-10" title="Status">{{tr.activestatus}}</button></td>
                    ...
                    <td class="hidden-print"><button class="buttoncolor" title="View"><a style="color:#000000;" target="_blank" :href="'/club-hospitality/membership/membership-view/' + tr.id"><i class="fas fa-eye"></i></a></button></td>
                    <td class="hidden-print"><button class="buttoncolor" title="Edit"><a style="color:#000000;" target="_blank" :href="'/club-hospitality/membership/membership-aeu/' + tr.id"><i class="fas fa-edit"></i></a></button></td>
...
if(  moment(a.card_exp).isBefore(CurrentDate)==true){
    return  moment(a.card_exp).format("dd-mm-yyyy") <= moment(CurrentDate).format("dd-mm-yyyy")
            ...
            init:function () {
                ...
                this.$http.get('/club-hospitality/membership/init_vue').then(result=>{
