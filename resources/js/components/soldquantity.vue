            ...
            <table class="myFormat table-hover " style="width: 100%;">
                ...
                <template v-for="(s,key) in  sliceP(
                    ...
                    <tr v-if="sales[key+1]==undefined ||  sales[key+1].sub!=s.sub">
                        ...
                        <td><STRONG style="text-transform: uppercase;  border-top: 1px solid #000!important;">{{parseFloat((s.tsales).toFixed(2)).toLocaleString()}}</STRONG></td>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/sold-quantity-report/soldquantity_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
