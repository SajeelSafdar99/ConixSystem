...
<!--    <div v-if="this.exported" class="hidden-print">
    ...
    <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
        <h5>AFOHS <br>REVENUE SUMMARY REPORT (SECTION-WISE) </h5>
    </div>
<!--
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/revenue-summary/revenuesummary_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
