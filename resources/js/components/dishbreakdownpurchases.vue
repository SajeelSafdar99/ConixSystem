...
-->
        ...
        <br>
        <div class="row">
            <label class="col-sm-2 form-control-label">SUPPLIER NAME:</label>
            <div class="col-sm-10">
            ...
            <table class="myFormat table-hover " style="width: 100%;">
              ...
              <!--          <td><STRONG>SUB TOTAL</STRONG></td>-->
                    ...
                    <tr>
                      ...
                      <!--  <td>{{parseInt(s.purchase_price)*parseInt(s.qty) | numFormat }}</td>-->
                    ...
                    <tr v-if="sales[key+1]==undefined ||  sales[key+1].sub!=s.sub">
                        ...
                        <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{ s.tsales?(s.tsales).toFixed(2):(s.tsales) }}</STRONG></td>
                ...
                <!--        <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{s.subtt | numFormat }}</STRONG></td>-->
                        <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{(s.subtt-s.tdics) | numFormat}}</STRONG></td>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/dish-breakdown-purchase-summary/dishbreakdownpurchase_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
