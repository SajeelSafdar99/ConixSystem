...
<template>
 ...
 <!--       TABLE RESERVATION-->
        <div v-if="saveAsReservation && !this.id">
                        ...
                        <div class="modal-dialog " style="max-width: 735px !important;">
                            <div class="modal-content" style=" width: 800px !important;">
                                <div class="modal-header">
                                    ...
                                    <h5 class="modal-title"><b>TABLE RESERVATION:</b></h5>
                                    <button type="button" class="close" @click="saveAsReservation=false">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Reservation #: </span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="number" name="reservation_no" v-model="reservation_no" class="form-control input-height" autocomplete="off" readonly placeholder="Enter Reservation No.">
                                        </div>
                                    </div>
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Reservation Date: </span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <datepicker v-model="reservation_date" :clear-button="true" placeholder="dd/mm/yyyy" format="dd/MM/yyyy" input-class="form-control input-height" name="reservation_date" autocomplete="off"></datepicker>
                                        </div>
                                    </div>
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Nature of Function: </span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="nature_of_function" v-model="nature_of_function" class="form-control input-height" autocomplete="off" placeholder="Enter Function Details">
                                        </div>
                                    </div>
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Time: </span></label>
                                        <div class="col-sm-5 mg-t-10 mg-sm-t-0">
                                            <vue-timepicker v-model="from_time" name="from_time"  input-class="form-control input-height"  autocomplete="off" placeholder="From (hh:mm A)" format="hh:mm A"></vue-timepicker>

                                            <vue-timepicker v-model="to_time" name="to_time"  input-class="form-control input-height"  autocomplete="off" placeholder="To (hh:mm A)" format="hh:mm A"></vue-timepicker>
                                        </div>
                                        <div class="col-sm-1 mg-t-10 mg-sm-t-0">
                                        </div>
                                    </div>
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Theme of Function: </span></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <input type="text" name="theme" v-model="theme" class="form-control input-height" autocomplete="off" placeholder="Enter Theme">
                                        </div>
                                    </div>

                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><span style="font-size: 16px;">Arrangement Details / Special Instructions: </span> </label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                          <textarea class="form-control" v-model="arrangement_details" placeholder="Enter Details" rows="2" type="text" name="arrangement_details"></textarea>
                                        </div> </div>
                                </div>
                                <div class="modal-footer">
                                    <button type="button" class="btn btn-info" @click="save_as_reservation(); saveAsReservation=false;">Done</button>
                                    <button type="button" class="btn btn-secondary" @click="saveAsReservation=false">Cancel</button>
                                </div>
                            </div>
                        </div>
                    </div>
                    ...
                    <div class="modal-wrapper">
                        <div class="modal-dialog">
                            <div class="modal-content">
                                ...
                                <div class="modal-body">
                                    <input autofocus placeholder="Type Here..." @input="enterinsts(active_el)" class="form-control input-height" v-model="instruction" id="instruction">
                                </div>
                                <div class="modal-footer">
                                ...
                                <div class="modal-body">
                                    ...
                                    <div class="row mg-t-10">
                                        ...
                                        <template v-if="sum(pluck(discounts.filter((a)=>{return ((a.trans_amount)-(a.sum)>0) }),'trans_amount'))-sum(pluck(discounts.filter((a)=>{return ((a.trans_amount)-(a.sum)>0) }),'sum'))>0">
                                            <div class="col-sm-6 mg-t-10 mg-sm-t-0">
                                                <input type="checkbox" name="lediscount" id="lediscount" v-model="lediscount" >
                                                <label for="lediscount">Discount</label>
                                            </div>
                                        </template>
                                    </div>

                                    <template v-if="this.advance==false && this.lediscount==false">
                                     <div class="row">
                      ...
                      <i class="fas fa-chevron-circle-left "  style="color:#fff"></i>
                                    ...
                                    <div class="scrollclass">
                                        ...
                                        <div class="inner" :style="'margin-top:'+AccTypeMargin+'px'">
                                            ...
                                            <div class="scrollsub waiterdiv waiter" :style="'width:142px; text-align:center;padding: calc(142px - 121px - '+(acctype.name.length>18?21:10)+'px);'" v-if="acc_permission.indexOf(acctype.name+' '+acctype.mod_id)!=-1" v-for="acctype in acctypes.filter((z)=>{return (this.account?this.accounts.filter((a)=>{return a.code==this.account})[0].cost_center:0)==(this.pms.filter((b)=>{return b.id==z.mod_id})[0].coa_trans_type)})" @click="sAccType=acctype.id" v-bind:class="{'active':sAccType==acctype.id}">
                                                <b>{{acctype.name}}</b>
                                            </div>
                                        </div>
                                    ...
                                    <div class="row  mg-t-10">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <b style="font-size: 18px;"><template v-if="this.shouldiappear==1">{{Math.round(this.grandtotal)}}</template><template v-else>{{Math.round(this.tempgrandtotal)}}</template></b>
                                            <br>
                                            <span style="font-size: 16px; text-transform: uppercase;"><template v-if="this.shouldiappear==1">({{toWords(Math.round(this.grandtotal))}})</template><template v-else>({{toWords(Math.round(this.tempgrandtotal))}})</template></span>
                                    </div> </div>

                                    <template v-if="this.advance==false && this.lediscount==false">
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><b style="font-size: 16px;"> Entertainment: </b></label>
                                        <div class="col-sm-2 mg-t-10 mg-sm-t-0">
                                            <input type="radio" class="form-control input-height" value="1" v-model="ent"  @click="uncheckrdio(1)">
                                        </div>
                                        <label class="col-sm-4 form-control-label"><b style="font-size: 16px;"> CTS: </b></label>
                                        <div class="col-sm-2 mg-t-10 mg-sm-t-0">
                                            <input type="radio" class="form-control input-height" value="2" v-model="ent"  @click="uncheckrdio(2)">
                                        </div>
                                    </div>
                                    </template>
                                    ...
                                    <div class="row  mg-t-10">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <template v-if="this.ent==1">
                                                <input type="number" v-model="amount_received" class="form-control input-height" placeholder="Enter Amount" readonly>
                                            </template>
                                            <template v-else>
                                   ...
                                   <!-- <input type="number" v-model="amount_received" class="form-control input-height" placeholder="Enter Amount">-->
                                    ...
                                    <div class="row  mg-t-10">
                                        ...
                                        <template v-if="this.shouldiappear==1">
                                                <template v-if="parseFloat(amount_received)>(Math.round(grandtotal))">
                                                    <input type="number" name="return_value" class="form-control input-height" placeholder="Balance" :value="(Math.round(grandtotal))-parseFloat(amount_received)" id="return_value" autocomplete="off">
                                                </template>
                                                <template v-else>
                                        ...
                                        <template v-else>
                                                <template v-if="parseFloat(amount_received)>(Math.round(tempgrandtotal))">
                                                    <input type="number" name="return_value" class="form-control input-height" placeholder="Balance" :value="(Math.round(tempgrandtotal))-parseFloat(amount_received)" id="return_value" autocomplete="off">
                                                </template>
                                                <template v-else>
                                                    <input type="number" name="return_value" class="form-control input-height" placeholder="Balance" :value="0" id="return_value" autocomplete="off">
                                                </template>
                                    ...
                                    <div class="row  mg-t-10">
                                        ...
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <template v-if="this.shouldiappear==1">
                                                <template v-if="parseFloat(amount_received)>(Math.round(grandtotal))">
                                                    <input type="number" name="cash_receipt_amt" class="form-control input-height" placeholder="Receipt Amount" :value="(Math.round(grandtotal))-parseFloat(amount_received)+parseFloat(amount_received)" readonly autocomplete="off">
                                                </template>
                                                <template v-else>
                                            ...
                                            <template v-else>
                                                <template v-if="parseFloat(amount_received)>(Math.round(tempgrandtotal))">
                                                    <input type="number" name="cash_receipt_amt" class="form-control input-height" placeholder="Receipt Amount" :value="(Math.round(tempgrandtotal))-parseFloat(amount_received)+parseFloat(amount_received)" readonly autocomplete="off">
                                                </template>
                                                <template v-else>
                                    ...
                                    <div class="row  mg-t-10">
                                        <label class="col-sm-4 form-control-label"><b style="font-size: 16px;"> ENT Details: </b></label>
                                        <div class="col-sm-8 mg-t-10 mg-sm-t-0">
                                            <select v-model="ent_detail"  class="form-control">
                                                <option :value="0">Choose Option</option>
                                                <option :value="e.id" v-for="e in ent_details">{{e.desc}}</option>
                                            </select>
                                        </div>
                                    </div>
                                    </div>
                                <div class="modal-footer">
                                    <template v-if="this.printedornot==2 && this.shouldiappear==1">
                                        <input @click="receive_payment_datatable(id); showModalPayment=false" :class="'btn-info'" type="submit" name="save" class="btn" :value="'Edit & Receive'">
                                    </template>
                                    <template v-else>
                                        <input @click="receive_payment(id);" :class="id?'btn-info':'btn-info'" type="submit" name="save" class="btn" :value="id?'Receive':'Receive'">
                ...
                <div class="modal-mask">
                    <div class="modal-wrapper">
                      ...
                      <i class="fas fa-chevron-circle-left "  style="color:#fff"></i>
                                ...
                                <div class="modal-footer">
                                    <template v-if="this.printedornot==2 && this.shouldiappear==1">
                                        <input @click="receive_payment_datatable(id); FinalEditOrder=false; " :class="'btn-info'" type="submit" name="save" class="btn" :value="'Edit & Receive'">
                                    </template>
                                    <template v-else>
                                        <input @click="receive_payment(id,final);" :class="id?'btn-info':'btn-info'" type="submit" name="save" class="btn" :value="id?'Receive':'Receive'">
                                        <!--<input @click="unpay_payment(id)" :class="id?'btn-danger':'btn-danger'" type="submit" name="save" class="btn" :value="id?'Unpaid':'Unpaid'">-->
                                    </template>
                                </div>
                            </div>
...
'    height: 61px;margin-top:'+tableMargin+'px'">
                                                <div class="scrollsubrests" v-for="table in tables" >
                                                    ...
                                                    <template v-if="bookedTables.length>0 && bookedTables.indexOf(String(table.id))!=-1">
                                                        <div v-if="datatableid" class="tabledefs booked" @click="sTable=table.id;"
                                                    ...
                                                    <template v-else-if="printedTables.length>0 && printedTables.indexOf(String(table.id))!=-1">
                                                        <div v-if="datatableid" class="tabledefs printed" @click="sTable=table.id;"
                                                             v-bind:class="{'active':sTable==table.id}">
    ...
    <div class="row">
        ...
        <div class="col-sm-5">
            <div class="form-layout form-layout-4 blackcolor">
                ...
                <div class="row">
                    <label class="col-sm-2 form-control-label"> Company: <span class="tx-danger">  *  </span> </label>
                    ...
                    <label class="col-sm-2 form-control-label">Restaurant Tables:</label>
                    <div class="col-sm-3 mg-t-10 mg-sm-t-0">
                        <select v-model="sResturant" id="restaurant_location" name="restaurant_location" class="form-control select2">

                            <option v-for="rest in resturants.filter((a)=>{return a.unit==this.company})" :value="rest.id">
                                {{rest.desc}}
                            </option>
                        </select>
                    </div>
                    <div class="col-sm-2 arrowsResturant" v-if="tables.length>12">
                        <span @click="tableMargin/60<0?tableMargin=tableMargin+60:''"><i class="fas fa-chevron-circle-left fa-3x" style="color:cadetblue"></i></span>
...
'    height: 61px;margin-top:'+tableMargin+'px'">
                        <div class="scrollsubrests" v-for="table in tables" >
                            ...
                            <template v-else>
                                <div class="tabledefs" @click="table_open(table.id); "
                                     v-bind:class="{'active':sTable==table.id}">
            ...
            <div class="form-layout form-layout-4 blackcolor">
                <div class="row">
                <label class="col-sm-2 form-control-label">Booking #:</label>
                <div class="col-sm-4 mg-t-10 mg-sm-t-0">
                    <input  v-model="cakebooking" name="cakebooking" id="cakebooking" value="" class="typeahead form-control" autocomplete="off" type="text" placeholder="Search Cake Booking">
                    <ul id="areabox3" class="areabox" style="color: #fff;background: aliceblue;
                list-style-type: none;color: black;" v-if="cakebookings.length>0">
                        <li @click="cakebookingvalue(dc.id)" v-for="dc in cakebookings">
                            {{dc.booking_no}}
                        </li>
                    </ul>
                </div>
                    <label class="col-sm-2 form-control-label">Reservation #:</label>
                    <div class="col-sm-4 mg-t-10 mg-sm-t-0">
                        <input v-model="reservation" name="reservation" id="reservation" value="" class="typeahead form-control" autocomplete="off" type="text" placeholder="Search Table Reservation">
                        <ul id="areabox4" class="areabox" style="color: #fff;background: aliceblue;
                list-style-type: none;color: black;" v-if="reservations.length>0">
                            <li @click="reservationvalue(dc.id)" v-for="dc in reservations">
                                {{dc.reservation_no}}
                            </li>
                        </ul>
                    </div>
                ...
                <div class="row">
                    <div class="col-md-4">
                        <label class="rdiobox">
                            <input type="radio" name="type" v-model="type" @change="emptythetype()" value="8"><span class="pabs">Member</span></label>


                        <label class="rdiobox">
                            <input type="radio" name="type" v-model="type" @change="emptythetype()" value="6"><span class="pabs">Corporate Member</span></label>


                        <label v-for="gt in gts" class="rdiobox">
                            <input type="radio" name="type" v-model="type" @change="emptythetype()" :value="10+gt.id"><span class="pabs">{{gt.desc}}</span>
                        </label>
                        <!--<label class="rdiobox">
                    ...
                    <div class="col-md-8">
                       ...
                       <input  v-model="customer" name="name" id="name" value="" class="typeahead form-control" autocomplete="off" type="text" :placeholder="'Search '+(type==8?'Member':type==6?'Corporate Member':type==3?'Employee':'Guest')">
                ...
                list-style-type: none;color: black;" v-if="customers.length>0 && customer!=''" >
                        ...
                        <div class="form-group">
                            <input v-if="type==11" type="text" v-model="temp_person_name" name="temp_person_name" class="typeahead form-control" autocomplete="off" placeholder="Enter Person Name">
                        </div>
                        <div class="form-group float-left"  style="width:49%">
                            <input v-model="customer_id" class="form-control"  name="customer_id" id="customer_id" type="text" :placeholder="(type==8?'Member':type==6?'Corporate Member':type==3?'Employee':'Guest')+' ID'" readonly>
                            <input v-model="member_id" name="member_id" id="member_id" type="hidden"></div>
                        
                    <div class="form-group float-right" style="width:49%">
                        <input class="form-control" :placeholder="(type==8?'Member':type==6?'Corporate Member':type==3?'Employee':'Guest')+' Ledger Amount'" readonly v-model="ledger_amount" name="ledger_amount" id="ledger_amount" type="number"></div>
                        <div class="form-group">
                    <select  id="family" class="form-control family" v-model="family">
                        ...
                        <option :value="fam.id" v-for="fam in families">
                            {{fam.first_name}} {{fam.name}} ({{fam.sup_card_no}}) - {{fam.status_name?fam.status_name.desc:''}}
                        </option>
                    </select>
...
<!--{{fam.relationship_name.desc}}-->
    ...
    overflow: hidden; " :title="tr.item_details">{{tr.item_details}}</span></td>
                               ...
                               <!-- <td><span v-if="tr.taxable==1"><span v-if="taxandservice.tax_amount">{{tr.varTax=Math.round(taxandservice.tax_amount)}}</span> <span v-if="taxandservice.tax_percentage">{{tr.varTax=Math.round((taxandservice.tax_percentage/100)*tr.totalamt)}}</span></span> <span v-else> 0</span>  </td>
                                ...
                                <td>{{!tr.kot_no?tr.kot=kot:tr.kot=tr.kot_no}}</td>
        ...
        <div class="col-sm-4">
            ...
            <div class="form-layout form-layout-4 blackcolor">
<span> You are currently logged in at : {{poss.filter((a)=>{return a.id==this.cur_pos}).length>0?poss.filter((a)=>{return a.id==this.cur_pos})[0].name:''}} </span>
<br><br>
...
<br>
                <div class="float-left">
                    <b>Disc:</b>  {{ Math.round(vardiscounted = (selected_items.length>0?sum(pluck(selected_items,'varDisc')):0))}}
                </div>
                <div class="float-right">
                    <b>Service Charges:</b>
                ...
                <br>
                <div class="float-left">
                    <b>Sub Total:</b> {{ Math.round(subtotal = (varGross - vardiscounted))}}
                </div>
                <br>
                ...
                <div class="float-left">
                    <h5>Grand Total:
                        <template v-if="!vartaxedpct==''">
                            <template v-if="!varserviced==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(vartaxedamt) + parseFloat(varserviced)))}}</template>
                            <template v-else-if="!varserviced_pct==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(vartaxedamt) + parseFloat((varserviced_pct/100)*subtotal)))}}</template>
                            <template v-else>{{Math.round(grandtotal =(parseFloat(subtotal) + parseFloat((vartaxedpct/100)*subtotal) ))}}</template>
                        </template>
                        <template v-else-if="vartaxedamt==''">
                            <template v-if="!varserviced==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(vartaxedamt) + parseFloat(varserviced)))}}</template>
                            <template v-else-if="!varserviced_pct==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(vartaxedamt) + parseFloat((varserviced_pct/100)*subtotal)))}}</template>
                            <template v-else>{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(vartaxedamt) ))}}</template>
                        </template>
                        <template v-else>
                            <template v-if="!varserviced==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat(varserviced)))}}</template>
                            <template v-else-if="!varserviced_pct==''">{{Math.round(grandtotal = (parseFloat(subtotal) + parseFloat((varserviced_pct/100)*subtotal)))}}</template>
                            <template v-else>{{Math.round(grandtotal = (parseFloat(subtotal) ))}}</template>
                        </template>
                    </h5>
                </div>
<br>
            ...
            <div class="form-layout form-layout-4">
                <div class="row finishbuttons">
                    <div class="col-sm-12">
                        <template v-if="(this.printedornot!=1) && (this.printedornot!=2) && this.caneditsale">
                            <input @click="save_sales(id)" :disabled="disableds"  :class="id?'btn-info':'btn-info'" type="submit" name="save" class="btn" :value="id?'Edit Order [F10]':'Save Order [F10]'">
                        </template>

                        <template v-if="!this.id && (this.printedornot!=1) && (this.printedornot!=2) && this.caneditsale">
                            <input  @click="saveAsReservation=true" :disabled="disableds"  class="btn btn-warning" type="submit" name="save" value="Reserve [F9]">
                        </template>
                        ...
                        <template v-if="(this.printedornot!=1 && this.id && this.printedornot==0) || (this.printedornot!=1 && this.id && this.caneditsale)">
                            <button @click="move_table(id)" class="btn btn-warning">Move Table</button>
                        </template>
                        <template v-if="(this.id && this.printedornot==0 && this.printedornot!=1 && !this.datatableid) || (this.id && this.caneditsale && this.printedornot!=1 && !this.datatableid)">
                            <button @click="generate_invoice(id)" class="btn btn-secondary">Generate Bill [F11]</button>
                        ...
                        <a href="/food-and-beverage/sales/sales-aeu"><button class="btn btn-secondary">Refresh [F5]</button></a>

                        <template v-if="this.id">
                            <button v-if="this.id" @click="reprintkot(id)"   class="btn btn-secondary">Re-Issue KOT [F8]</button>

                        </template>
                        <a href="/food-and-beverage/sales-list-vue" target="_blank"><button class="btn btn-secondary">Re-Issue Bill [F12]</button></a>
        ...
        data(){
          ...
          return  {
            ...
            /* showModalPayment: this.datatableid?false:true,*/
              ...
              sMode:'',
              sType:'',
              sCancelledRemark:'CANCELLED BY CUSTOMER',
              sResturant:'1',
              sResturantName:'',
              sAccHead:'',
              sAccType:'',
              ...
              cakebooking:'',
              cakebookings:[],
              reservationSearched:false,
              saveAsReservation:false,
              reservation_no:'',
              reservation_date:'',
              nature_of_function:'',
              from_time:'',
...
poss:[],
       ...
       /* computed: {
        ...
        watch:{
            ent:function(){
                if(this.ent==1){
                    console.log(this.tempgrandtotal);
                    if(this.shouldiappear==1){
                        this.amount_received=Math.round(this.grandtotal);
                    }
                    else{
                        this.amount_received=Math.round(this.tempgrandtotal);
                    }
                }
            },
            sResturant:function(){
           ...
           /* sAccHead:function(){
            ...
            cakebooking:function(){
                if(this.cakebooking.length==0){
                    this.cakeSearched=false;
                }
                if(this.cakebooking.length>0 && !this.cakeSearched){
                    this.cakebookingdata();
                }
            },
            reservation:function(){
                if(this.reservation.length==0){
                    this.reservationSearched=false;
                }
                if(this.reservation.length>0 && !this.reservationSearched){
            ...
            search:function(){
                ...
                else if(parseInt(this.search)==this.search){
                    this.itemsdata();
        ...
        methods: {
            ...
            table_open: function (tableid) {
                let url = '/food-and-beverage/sales/check-user-shift';
                this.$http.get(url).then(result => {
                    if(result.data==1){
                        ...
                        alert('Please log into a POS first !');
                    }
                });
                /*
window.location.href='/food-and-beverage/sales/sales-aeu?t='+tableid;*/
            ...
            receive_payment: function (m,final) {

                let data = {
                    company:this.company,
                    advance:this.advance==true?1:0,
                    lediscount:this.lediscount==true?1:0,
                    return_value: this.amount_received > Math.round(this.tempgrandtotal) ? Math.round(this.tempgrandtotal) - parseFloat(this.amount_received) : 0,
                    cash_receipt_amt: this.amount_received > Math.round(this.tempgrandtotal) ? Math.round(this.tempgrandtotal)-parseFloat(this.amount_received)+parseFloat(this.amount_received): 0+parseFloat(this.amount_received),
                    ent: this.ent,
                    ent_detail: this.ent_detail,
                    ...
                    amount_in_words: this.toWords(Math.round(this.grandtotal))
                };
                ...
                if(this.ent==1 && !this.remarks) {
                    alert('Comments are required !');
                }
                else if(this.ent==1 && (this.ent_detail==0 || this.ent_detail==null || this.ent_detail=='')) {
                    alert('ENT Details are required !');
                }
                else{
                    if((this.advance!=1 && !this.account) && (this.lediscount!=1 && !this.account)) {
                        alert('Cash / Bank is required !');
                    }
                    else if((this.advance!=1 && !this.sAccType) && (this.lediscount!=1 && !this.sAccType)) {
                        alert('Payment Method is required !');
                    }
                    else {
                       /* if (this.validation(data, ['sAccType', 'account']) == 0) {*/
                            this.$http.post(url, data).then(result => {
                                this.init();
                                if (final) {
                                    this.FinalEditOrder = false;
                                } else {
            ...
            receive_payment_datatable: function (m) {
                ...
                // console.log(this.amount_received > this.grandtotal ? parseFloat(this.grandtotal)-parseFloat(this.amount_received)+parseFloat(this.amount_received): 0+parseFloat(this.amount_received))
                let data = {
                    company:this.company,
                    advance:this.advance==true?1:0,
                    lediscount:this.lediscount==true?1:0,
                    return_value: this.amount_received > Math.round(this.grandtotal) ? Math.round(this.grandtotal) - parseFloat(this.amount_received) : 0,
                    cash_receipt_amt: this.amount_received > Math.round(this.grandtotal) ? Math.round(this.grandtotal) - parseFloat(this.amount_received) + parseFloat(this.amount_received) : 0 + parseFloat(this.amount_received),
                    amount_received: this.amount_received ? this.amount_received : 0,
                    remarks: this.remarks,
                    sAccHead: this.acctypes.filter((a) => {
                        return a.id == this.sAccType
                ...
                if (this.ent==1 && !this.remarks) {
                    ...
                    if((this.advance!=1 && !this.account) && (this.lediscount!=1 && !this.account)) {
                        ...
                        if (this.validation(data, ['customer', 'customer_id', 'sTable', 'sType', 'selected_items', 'company', 'type']) == 0) { //, 'sAccType', 'account'
                        this.$http.post(url, data).then(result => {
                 ...
                 window.open("/food-and-beverage/sales/sales-kot/"+result.data, "_blank");
                    ...
                    window.location.href = "/food-and-beverage/sales/sales-aeu/"+result.data;*/
                            /*this.printing=true;*/
                            if (m) {
                                let sub_cats = this.pluck(this.selected_items, 'category').filter((a, b, c) => {
...
console.log(this.sTable);
            ...
            save_as_reservation:function(m){
                ...
                let data={
                    ...
                    nature_of_function:this.nature_of_function,
                    from_time:this.from_time,
                    to_time:this.to_time,
                    theme:this.theme,
                    arrangement_details:this.arrangement_details,
                };
                let url='/food-and-beverage/sales/sales-aeu/reserve';

                if(this.validation(data,['reservation_no','reservation_date','nature_of_function', 'from_time','to_time','theme','date', 'time','shift','customer' ,'customer_id','sTable','sType','selected_items', 'type'])==0){
                    ...
                    this.$http.post(url,data).then(result=> {
                        ...
                        this.$snotify.error('Something went wrong ! Reserve table again.');
                    });
            ...
            save_sales:function(m){
               ...
               /* let sel=this;
                ...
                setInterval(function(){
                    if(!sel.refreshmyinterval){


                        sel.$http.get('/kotget').then((a)=>{
                            sel.kot=a.data;
                        })
                    }
                },3000)
*/
                ...
                let data={
                    ...
                    service_pct:this.varserviced_pct,
                    grandtotal:this.grandtotal,
                    temp_person_name:this.temp_person_name
                };
...
if(this.validation(data,['date', 'time','shift','customer' ,'customer_id','sTable','sType','selected_items', 'company', 'type'])==0){
    this.disableds=true;
  /*  this.$snotify.async('Printing is in process !', 'Printing...', () => new Promise((resolve, reject) => {
        setTimeout(() => resolve({
            title: 'Success!!!',
    ...
    this.$http.post(url,data).then(result=> {
        ...
        if(result.data.status === "error" && result.status==200){
          //  console.log(result);
            this.$snotify.error('Something went wrong ! Save order again.');
            this.disableds=false;
            // this.init();
            // this.sTable = '';
            return false;
        ...
        {
            this.$snotify.success('Printing is in process !', 'Printing...', () => new Promise((resolve, reject) => {
                setTimeout(() => resolve({
                    title: 'Success!!!',
                    body: 'Printing successfully done !',
                    config: {
        ...
        if (m) {
            ...
            sub_cats.forEach((x, y) => {
                ...
                let ptwo = this.mains.filter((a) => {
                    return a.id == x
                })[0].printer_two;
                let inikot = this.selected_items.filter((a) => {
                    return a.category == x
                })[0].kot;
                ...
                if (p) {
                    $.ajax({
                        type: 'get',
                        //  async:false,
                        url: printer + '?printer=' + p + '&file=' + file + m + '/' + inikot + '/' + x,
                        crossDomain: true,
                ...
                if (ptwo) {
                    $.ajax({
                        type: 'get',
                        //    async:false,
                        url: printer + '?printer=' + ptwo + '&file=' + file + m + '/' + inikot + '/' + x,
                        crossDomain: true,
                ...
                if(this.xpprinter)
                {
                    let xpfile = window.location.protocol + '//' + window.location.host + '/fb/sales/xpedittedsaleskot/';
                    let pthree = this.xpprinter;
                    $.ajax({
                        type: 'get',
                        //    async:false,
                        url: printer + '?printer=' + pthree + '&file=' + xpfile + m+ '/' + inikot+ '/' + x, //(this.kot+1),
                        crossDomain: true,
                ...
                if(this.xpprintertwo){
                    let xpfiletwo = window.location.protocol + '//' + window.location.host + '/fb/sales/xpedittedsaleskot/';
                    let pfour = this.xpprintertwo;
                    $.ajax({
                        type: 'get',
                        //    async:false,
                        url: printer + '?printer=' + pfour + '&file=' + xpfiletwo + m+ '/' + inikot+ '/' + x, //(this.kot+1),
                        crossDomain: true,
            ...
            sub_cats.forEach((x, y) => {
                ...
                if (p) {
                    $.ajax({
                        type: 'get',
                        //async:false,
                        url: printer + '?printer=' + p + '&file=' + file + resultant + '/' + inikot + '/' + x,
                ...
                if (ptwo) {
                    $.ajax({
                        type: 'get',
                        //async:false,
                        url: printer + '?printer=' + ptwo + '&file=' + file + resultant + '/' + inikot + '/' + x,
            ...
            if(this.xpprinter)
            {
                let xpfile = window.location.protocol + '//' + window.location.host + '/fb/sales/xpduplicatesaleskot/';
                let pthree = this.xpprinter;
                $.ajax({
                    type: 'get',
                    //    async:false,
                    url: printer + '?printer=' + pthree + '&file=' + xpfile + resultant,
                    crossDomain: true,
            ...
            if(this.xpprintertwo)
            {
                let xpfiletwo = window.location.protocol + '//' + window.location.host + '/fb/sales/xpduplicatesaleskot/';
                let pfour = this.xpprintertwo;
                $.ajax({
                    type: 'get',
                    //    async:false,
                    url: printer + '?printer=' + pfour + '&file=' + xpfiletwo + resultant,
                    crossDomain: true,
                ...
                if(this.alternativeqty== this.selected_items[this.active_el].qty){
                    if(this.alternativeqty!=''){
                        ...
                        if(this.alternativeqty!=''){
                            ...
                            clone.subcategory=this.sCategory;
                        ...
                        this.alternativeqty='';
                        this.instruction='';
                        this.sCancelledRemark='CANCELLED BY CUSTOMER';
          ...
          */
            ...
            save_to_selected:function(item){
                ...
                if(this.quantity>0){
                    ...
                    if(this.sTable=='' || this.sType=='') {alert('Please select Table & Order Type first !'); return 0}
            ...
            init:function (m) {
                ...
                this.$http.get('/food-and-beverage/sales/sales-ini'+r).then(result=>{
                    ...
                    if(m && this.datatableid==m) {
                        this.temp_person_name = data.person_name;
                        this.amount_received=data.amount_received;
                        this.advance=data.advance==1?data.advance=true:false;
                        this.lediscount=data.lediscount==1?data.lediscount=true:false;

                        this.account=data.coa_trans_type?data.coa_trans_type:0;
                        ...
                        this.customerdatavalue(data.customer_id,m);
                        ...
                        this.ent_detail=data.ent_detail;
                        this.ent=data.ent;
                      ...
                      //  this.tables=data.tables;
                       ...
                       /* this.company='001-001';*/
                        this.advance=false;
                        this.lediscount=false;
                        this.printedornot='',
                        this.shouldiappear=0;
                        this.id='';
                        this.taxandservice=data.taxandservice;
                       ...
                       // this.tables=data.tables;
                        ...
                        this.acctypes=data.acctypes;
                        this.increment_number=data.increment_number;
                        this.reservation_no=data.reservation_number;
            ...
            /*            this.sResturant=1;*/
                    ...
                    this.ent_details=data.ent_details;
...
console.log(this.cat_permission);
                    ...
                    this.xpprintertwo=data.xpprintertwo;
                ...
                this.$http.post('/search/itemsdata?inv=1&MOC='+r,{theid:val}).then(result=>{
                    ...
                    if(data){
                        ...
                        if(this.quantity>0){
                            ...
                            if(this.sTable=='' || this.sType=='') {
                                alert('Please select Table & Order Type first !');
                            return 0;
                            }
            ...
            itemsdatavalueEnter(val,m){
                ...
                console.log(this.ffkey)
                this.$http.post('/search/itemsdata?inv=1&MOC='+r,{theid:this.searcheditemsdefs[this.ffkey].id}).then(result=>{
                    let data =result.data;
                    if(data){
                        this.itemalreadySearched=true;
                        if(this.quantity==''){
                        ...
                        if(this.quantity>0){
                            ...
                            else clone.subcategory=this.sCategory;
                            this.selected_items.unshift(clone);
            ...
            reservationdata(){
                this.$http.post('/search/reservationdatalike',{reservationno:this.reservation}).then(result=>{
                    let data =result.data;
                    data.filter((a)=>{a.reservation=a.reservation_no})
                    if(data) {
            ...
            reservationvalue(val){
                this.reservations=[];
                this.$http.post('/search/reservationdata',{reservationid:val}).then(result=>{
                    let data =result.data;
                    if(data){


                        this.reservationSearched=true;
                        this.reservation = data.reservation_no;
            ...
            cakebookingdata(){
                    this.$http.post('/search/cakebookingdatalike',{bookingno:this.cakebooking}).then(result=>{
                        let data =result.data;
                        data.filter((a)=>{a.cakebooking=a.booking_no})
                        if(data) {
                            if(this.sTable=='') alert('Please select Table first !');
                            else
                                this.cakebookings=data;
                        }
                    });
            },
            cakebookingvalue(val){
                this.cakebookings=[];
                this.$http.post('/search/cakebookingdata',{bookingid:val}).then(result=>{
                    let data =result.data;
                    if(data){
                        this.cakeSearched=true;
                        this.cakebooking = data.booking_no;
                        this.sType = 'Take Away';
                        this.covers = 1;
                        this.customerdatavalue(data.customer_id,this.id);
                        this.family = data.family;
                        this.disc = data.discount;
                        this.itemsdatavalue(data.cake_type,this.id,data.instructions);
            ...
            customerdatavalue(val,m){
                ...
                this.$http.post('/search/salescustomerdata?inv=1&balance=1&advance=1&discount=1&MOC='+v+r,{customerid:val}).then(result=>{
                    let data =result.data;
                    if(data){
                        ...
                        if (v == 8) {
                            ...
                            if(data.active==1 || data.active==12){
                                ...
                                alert('This membership has expired !\n\n'  +
                                    'STATUS: ' +  data.mem_status.desc+'\n' +
                                    'REASON: ' +  data.active_remarks);
                                ...
                                alert('Please consult Accounts Manager in order to continue with this Order !\n\n'  +
                                    'STATUS: ' +  data.mem_status.desc+'\n' +
                                'REASON: ' +  data.active_remarks);
                                this.customer_id ='';
                                this.member_id = '';
...
//discount card
                        ...
                        if(data.discountdata) {
                            this.discountcard = data.discountdata.card_number;


                                 if(data.discountdata.discount_amount){
                                     this.disc = data.discountdata.discount_amount;
                                     this.disc_pc = 0;
                                 }
                                  else{
                                   this.disc_pc = data.discountdata.discount_percentage;
                                     this.disc = 0;
                                 }
      ...
      // discount card
                        ...
                        let self=this;
                        self.advances.forEach(function(i){
                            i.sum=0;
                            i.sum2=0;
                        ...
                        self.discounts.forEach(function(i){
                            i.sum=0;
                            i.sum2=0;
...
this.alreadySearched=true;
            ...
            getWaiters:function(){
                this.$http.get('/food-and-beverage/sales/waiters/'+this.sResturant).then(result=>{
                    let data=result.data;
                    if(data){
                        this.waiters=data;
                    }
        ...
        mounted() {
            document.addEventListener('keydown', (event)=> {
                ...
                if (event.key === 'F10') {
                    if(this.disableds==false){
                        this.save_sales(this.id);
                        event.preventDefault();
                    }
                }if (event.key === 'F11' ) {
                    if((this.id && this.printedornot==0 && this.printedornot!=1 && !this.datatableid) || (this.id && this.caneditsale && this.printedornot!=1 && !this.datatableid))
                    {
                        this.generate_invoice(this.id)
                        event.preventDefault();
                    }
                }
                if (event.key === 'F9') {
                    if(this.disableds==false){
                        this.saveAsReservation=true;
                        event.preventDefault();
                    }
                }  if (event.key === 'F12') {

                        window.open('/food-and-beverage/sales-list-vue','_blank');
                    event.preventDefault();
                }if (event.key === 'F8') {

                        this.reprintkot(this.id);
                    event.preventDefault();
                }
                if (event.key === 'Enter') {
                    if( this.showModalPayment == true && this.id && this.printedornot==1){
                        this.receive_payment(this.id);
                        event.preventDefault();
                    }
                }
                if (event.key === 'Enter') {
                    if( this.FinalEditOrder == true && this.printedornot==2 && this.shouldiappear==1){
                        this.receive_payment_datatable(this.id);
                        if(this.amount_received!='' && this.sAccType!='') {
                            this.FinalEditOrder = false;
                        }
                        event.preventDefault();
                    }
                    else{
                        if( this.FinalEditOrder == true){
                            this.receive_payment(this.id);
                            event.preventDefault();
                        }
                    }
            ...
            // document.addEventListener("keydown", this.udf);
            setInterval(()=>{
                this.$forceUpdate();
            },500)
