                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                    ...
                    <tr>
                        ...
                        <td><strong>{{(totals.tsub) | numFormat }}</strong></td>
                        <td><strong>{{(totals.ttax) | numFormat }}</strong></td>
                        <td><strong>{{Math.round(totals.grand_total) | numFormat }}</strong></td>
                        <td><strong>{{(totals.paid_amount) | numFormat }}</strong></td>
                        <td><strong>{{ (Math.round(totals.grand_total)-totals.paid_amount) | numFormat }}</strong></td>
                        <td colspan="10"></td>
                    </tr>
                    <!-- <tr>
    ...
    methods:{
        ...
        init:function () {
           ...
           /* if(this.ent!='Include ENT & CTS'){
            ...
            if(this.tabledef.length>0 || this.waiter.length>0 || this.cashier.length>0 || this.acftype!=0 || this.rcashier.length>0 || this.ent!='Include ENT & CTS' || this.ent_detail.length>0 || this.start_date ||  this.end_date || this.booking_no || this.searchId || this.specific!=0 || this.mog!=2 || this.restaurant.length>0){
                d=d+'&kk='+1;
            }
