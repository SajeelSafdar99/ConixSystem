        ...
        <div class="row hidden-print">
            ...
            <div class="col-lg">
                <div>
                    ...
                    <datepicker :disabledDates="disabledDates" v-model="start_date_two" :clear-button="true" placeholder="From (dd/mm/yyyy)" format="dd/MM/yyyy" input-class="form-control" name="start_date_two"></datepicker>
            ...
            <div class="col-lg">
                <div>
                    ...
                    <datepicker :disabledDates="disabledDates" v-model="end_date_two" :clear-button="true" placeholder="To (dd/mm/yyyy)" format="dd/MM/yyyy" input-class="form-control" name="end_date_two"></datepicker>
                </div>
            </div>
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                     ...
                     return x;
                        ...
                        <td>{{tr.user}}</td>
                        <td class="hidden-print"><button class="buttoncolor" title="Print Invoice"><a style="color:#000000;" target="_blank" :href="'/events-management/event-checkout/invoice/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td>
                        <td class="hidden-print"><button class="buttoncolor" title="Edit"><a style="color:#000000;" target="_blank" :href="'/events-management/event-checkout/edit/' + tr.id"><i class="fas fa-edit"></i></a></button></td>
                    </tr>
                    </tbody>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/events-management/event-checkout/init_checkout').then(result=>{
