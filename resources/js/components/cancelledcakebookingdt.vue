                    ...
                    <div class="modal-dialog">
                        <div class="modal-content">
                            ...
                            <div class="modal-footer">
                                <button @click="CancelTheBooking=false;" class="btn btn-sm btn-outline-success active"><a style="color:white;" :href="''">YES</a></button>
                                <button type="button" class="btn btn-danger" @click="CancelTheBooking=false">NO</button>
                            </div>
                        </div>
                    </div>
                </div>
...
-->
                 ...
                 <!--   <th class="wd-10p">AMOUNT PAID</th>
                    ...
                    <th class="wd-10p hidden-print">UNDO</th>
                </tr>
                </thead>
...
-->
                    ...
                    <td class="hidden-print"><a style="color:#000000;" onclick="return confirm('Are you sure ?')" :href="'/food-and-beverage/cake-booking/reconfirm/' + tr.id"><button class="buttoncolor btn btn-sm btn-warning" title="Re-Confirm">Re-Confirm</button></a></td>
                    </tr>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/food-and-beverage/cake-booking/cancelled_cakebooking_init_dt').then(result=>{
