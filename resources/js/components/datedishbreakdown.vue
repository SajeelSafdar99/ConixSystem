...
<div v-if="this.exported" class="hidden-print">
           <export-excel
                ...
                name    = "DateDishBreakdown.xls">
            </export-excel>
</div>

            <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
                <h5>AFOHS <br> DISH BREAKDOWN SUMMARY (DATE-WISE)</h5>
                ...
                <div class="scrollclasstable1">
                    ...
                    <div>
                        ...
                        <table class=" table-bordered table-hover " style="width: 100%;">
                            <tbody>
                            <tr>
                                <td class="wd-10p" style="border-top: none !important; border-right: none !important; border-left: none !important;"></td>
                                <td class="wd-10p" style="border-top: none !important; border-left: none !important;"></td>
                                <td class="text-right"><STRONG>2020-01-01</STRONG></td>
                                <td class="text-right"><STRONG>2020-01-02</STRONG></td>
                                <td class="text-uppercase text-right"><STRONG>Total</STRONG></td>
                            </tr>

                            <tr>
                                <td rowspan="6" class="text-uppercase text-left"><strong>DRINKS</strong></td>
                                <td class="text-uppercase text-right">Assorted Drink 1.5 LTR</td>
                                <td class="text-right">566 <br> 7883</td>
                                <td class="text-right">55 <br> 34245</td>
                                <td class="text-right">122 <br> 4413</td>
                            </tr>

                            <tr>

                                <td class="text-uppercase text-right">Club Special</td>
                                <td class="text-right">566 <br> 7883</td>
                                <td class="text-right">55 <br> 34245</td>
                                <td class="text-right">122 <br> 4413</td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-uppercase text-right">Fresh Lime</td>
                                <td class="text-right">566 <br> 7883</td>
                                <td class="text-right">55 <br> 34245</td>
                                <td class="text-right">122 <br> 4413</td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-uppercase text-right">Pina Colada</td>
                                <td class="text-right">566 <br> 7883</td>
                                <td class="text-right">55 <br> 34245</td>
                                <td class="text-right">122 <br> 4413</td>
                            </tr>
                            <tr>
                                ...
                                <td class="text-uppercase text-right">Seasonal Fresh Juice</td>
                                <td class="text-right">566 <br> 7883</td>
                                <td class="text-right">55 <br> 34245</td>
                                <td class="text-right">122 <br> 4413</td>
                            </tr>
                            ...
                            <tr>
                                ...
                                <td class="text-right"><strong>345</strong> <br> <strong>4234</strong></td>
                                <td class="text-right"><strong>342</strong> <br> <strong>32424</strong></td>
                                <td class="text-right"><strong>535</strong> <br> <strong>34245</strong></td>
                            </tr>
                            <tr>
                                <td colspan="2" class="text-uppercase text-right"><STRONG>TOTAL</STRONG></td>
                                <td class="text-right"><strong>345</strong> <br> <strong>4234</strong></td>
                                <td class="text-right"><strong>342</strong> <br> <strong>32424</strong></td>
                                <td class="text-right"><strong>535</strong> <br> <strong>34245</strong></td>
                            </tr>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/reports/date-dish-breakdown-summary/datedishbreakdownsummary_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
