    ...
    <div class="scrollclasstable1">
        ...
        <div>
            ...
            <table class="myFormat table-hover " style="width: 100%;">
                <tbody>
<!--  v-if="(key==0) || sales[key-1].cat!=s.cat" -->
                ...
                <template v-for="(s,key) in  sliceP(
                    ...
                    <tr>
                        ...
                        <td>{{s.location}}</td>
                        <td>{{s.department}}</td>
                        <td>{{ parseFloat((parseInt(s.sub_total)).toFixed(2)).toLocaleString()}}</td>
                    </tr>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/issue-note-summary/issuenotesummary_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
