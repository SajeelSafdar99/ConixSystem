                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                    ...
                    <template v-else-if="(parseInt(Math.round(tr.grand_total)-tr.paid_amount))>0">
                       <td><button class="btn btn-sm btn-outline-danger active"><a style="color:white;" target="_blank" :href="'/finance-and-management/finance-payment-receipts/finance-payment-receipts-aeu'+'?'+'empid=' + tr.employeeid">Unpaid</a></button></td>
                    </template>
                    <template v-else>
                    ...
                    <template v-if="tr.is_active==1">
                        <td class="hidden-print"><button type='button' class='btn btn-success btn-sm'>INV</button></td>
                    </template>
                 ...
                 <td class="hidden-print"><button class="buttoncolor" title="Delete"><a style="color:#000000;" :href="'/human-resource/employment/voucher/delete/' + tr.id"><i class="fa fa-trash" aria-hidden="true"></i></a></button></td>
                    <td class="hidden-print"><button class="buttoncolor" title="Print Voucher"><a style="color:#000000;" target="_blank" :href="'/human-resource/employment/voucher/print/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td>
                </tr>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/human-resource/employment/salary_init_vue').then(result=>{
