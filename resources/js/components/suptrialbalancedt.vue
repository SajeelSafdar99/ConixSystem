                                ...
                                <div class="modal-content">
                                    <div class="modal-header">
                                        ...
                                        <h5 class="modal-title">LEDGER ACCOUNTS:
                                            <a target="_blank" :href="'/finance-and-management/supplier-ledgers-vue'+'?'+'start_date=' + this.ssdata.start_date+'?'+'end_date=' + this.ssdata.end_date+'?'+'mog=' + this.ssdata.mog+'?'+'searchId=' + this.ssdata.searchId+'?'+'filter=' + this.ssdata.filter+'?'+'ent=' + this.ssdata.ent">  <button type="button" title="Print"
                                    ...
                                    <div class="modal-body">
                                        <supledgersdt :sdata="ssdata" v-if="ssdata" :key="'am'+k"></supledgersdt>
                                    </div>
        ...
        <div class="row  hidden-print">
            ...
            <div class="col-lg">
              <!--  <div class="row mb-2">
                ...
                <p style="color: black;">Supplier:</p>
...
<!--        <div class="row no-printme">
            ...
            <div>
                ...
                <button v-on:click="sign=0"  class=" btn btn-outline-primary disabled inactive btn-block mg-b-10 block">Total Balance: {{totals.debit -totals.credit | numFormat }}
                </button>
            </div>
            </div>
        </div>-->
                ...
                <table class="table-striped table-bordered  table-hover">
                    ...
                    <tr>
                     ...
                     <!--   <th class="wd-10p">TYPE</th>-->
                        <th class="wd-15p">SUPPLIER NO.</th>
...
<!--                    <tfoot>
                    <tr>
                        ...
                        <td><strong>{{(totals.debit) | numFormat }}</strong></td>
                        <td><strong>{{(totals.credit) | numFormat }}</strong></td>
                        <td><strong>{{(totals.credit - totals.debit) | numFormat }}</strong></td>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/supplier-trial-balance/supplier_init_vue?start_date='+(this.start_date?moment(this.start_date).format('YYYY-MM-DD'):'')+'&end_date='+(this.end_date?moment(this.end_date).format('YYYY-MM-DD'):'')+'&filter='+this.filter+'&ent='+this.ent).then(result=>{
