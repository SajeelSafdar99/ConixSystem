        ...
        data(){
            return{
                ...
                chartOptions:{
                    ...
                    title: {
                        text: 'SUBCATEGORY-WISE SALES ANALYSIS'
                    },
                    /*subtitle: {
                        ...
                        labels: {
                            ...
                            formatter: function() {
                             let d=moment(this.value);
                              return d.format('hh A')+' - '+d.add(1,'hour').format('hh A')
                            }
                        }
                    },
                    yAxis: {
...
data:[], pointWidth: 10,
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/subcategory-graphical-sales/subcategorysales_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
