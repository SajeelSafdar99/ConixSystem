...
<div v-if="this.exported" class="hidden-print">
           <export-excel
                ...
                name    = "RestaurantDishBreakdown.xls">
            </export-excel>
</div>

            <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
                <h5>AFOHS <br> DISH BREAKDOWN SUMMARY (RESTAURANT-WISE)</h5>
                ...
                <div class="scrollclasstable1">
                    ...
                    <div>
                     ...
                     return x;
                                ...
                                <tr v-if="(key==0) || sales[key-1].resturants!=s.resturants">
                                    <td colspan="7" class="sub"><u style="text-transform: uppercase;">{{s.resturants}}</u></td>
                                </tr>
                                ...
                                <tr v-if="sales[key+1]==undefined ||  sales[key+1].sub!=s.sub">
                                    ...
                                    <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{ ((s.ttsales).toFixed(2)).toLocaleString()}}</STRONG></td>
                                    <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG></STRONG></td>
                                    <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{s.tsubtt | numFormat }}</STRONG></td>
                                    <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{ parseFloat((s.ttdics).toFixed(2)).toLocaleString() }}</STRONG></td>
                                    <td style="text-transform: uppercase;  border-top: 1px solid #000!important;"><STRONG>{{ parseFloat((s.tsubtt-s.ttdics).toFixed(2)).toLocaleString() }}</STRONG></td>
                            ...
                            <tr style="border: 2px solid black;">
                                ...
                                <td><STRONG>{{ ((stdics).toFixed(2)).toLocaleString()  }}</STRONG></td>
                                <td><STRONG>{{ ((ssubtt-stdics).toFixed(2)).toLocaleString()  }}</STRONG></td>
                            </tr>
                            </tbody>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/reports/restaurant-dish-breakdown-summary/resdishbreakdownsummary_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
