                    ...
                    <div>
                     ...
                     return x;
                                ...
                                <tr style="border-bottom: 2px solid black;" class="head" v-if="(key==0)">
                                    <td><STRONG></STRONG></td>
                                    <td><STRONG>GROSS PURCHASE</STRONG></td>
                                ...
                                <!--    <td><STRONG>CASH PURCHASE</STRONG></td>
                                    ...
                                    <td><STRONG>PAID PURCHASE</STRONG></td>
                                    <td><STRONG>UNPAID PURCHASE</STRONG></td>
...
export default {
    ...
    methods:{
        ...
        init:function () {
            ...
            this.$http.get('/finance-and-management/reports/closing-purchases-report/closingpurchases_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
