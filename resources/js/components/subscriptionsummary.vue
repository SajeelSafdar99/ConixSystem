            ...
            <table class="table-striped table-bordered table-hover ">
                ...
                <tr>
                 ...
                 <tr >
                    ...
                    <td><STRONG>{{tcashgross}}</STRONG></td>
                    <td><STRONG>{{tcreditgross}}</STRONG></td>
                    <td><STRONG>{{tothergross}}</STRONG></td>
                     <td><STRONG> </STRONG></td>
        ...
        methods:{
            ...
            init:function () {
               ...
               let x='';
                ...
                this.$http.get('/finance-and-management/reports/subscriptions-maintenance-summary-ini?off=1'+x).then(result=>{
                    this.ttmo.forEach((a,b)=>{
                        this.ttmo[b]=0;
                    });
                    let data=result.data;
