...
<div v-if="this.exported" class="hidden-print">
   <export-excel
        ...
        name    = "DishBreakdownStoreSale.xls">
    </export-excel>
</div>

    <div style="text-align: center; color: black; letter-spacing: 0.2em !important;">
        <h5>AFOHS <br>DISH BREAKDOWN STORE SALE SUMMARY </h5>
    ...
    export default {
        ...
        methods:{
            ...
            init:function () {
                ...
                this.$http.get('/finance-and-management/reports/dish-breakdown-store-sale-summary/dishbreakdownsale_init_vue?1=1'+x).then(result=>{
                    let data=result.data;
                    if(!data.sales){
                        data.sales=[];
                    }
