    ...
    methods:{
        ...
        init:function () {
          ...
          if(this.specific){
            ...
            this.$http.get('/finance-and-management/reports/items-purchases-summary/itemsummary_init_vue?1=1'+x).then(result=>{
                let data=result.data;
                if(!data.sales){
                    data.sales=[];
                }
