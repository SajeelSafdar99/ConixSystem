            ...
            <div>
                <table class="table-striped table-bordered table-hover ">
                    ...
                    <tr>
                        ...
                        <th class="wd-30p">CANCELLATION DETAILS</th>
                        <th class="wd-10p">CANCELLED BY</th>
                        <th class="wd-5p hidden-print">UNDO</th>
                    </tr>
                    </thead>
                ...
                sliceP(
                  ...
                  if(parseInt(leng/pagelength)+((leng%pagelength)>0?1:0)<page){
                     ...
                     return x;
                        ...
                        <td>{{tr.cancel_details}}</td>
                        <td>{{tr.user}}</td>
                        <td class="hidden-print"><button class="btn btn-sm btn-outline-danger active"  @click="undome(tr.id);" title="Re-Confirm Event">Re-Confirm</button></td>
                    </tr>
                    </tbody>
...
export default {
    ...
    methods:{
        ...
        undome:function(k){
            let url='/events-management/event-booking/reconfirm/'+k;
                this.$http.post(url,k).then(result=> {
                    this.init();
                });
        },
        ...
        init:function () {
            ...
            this.$http.get('/events-management/event-booking/init_cancelled').then(result=>{
