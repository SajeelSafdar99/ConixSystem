    ...
    <div class="row hidden-print">
        ...
        <div class="col-lg">
                ...
                <input value="" class="form-control"  size="20" type="number"
                       ...
                       name="invoice_no" placeholder="Search By Note No.">
        </div>
        <div class="col-lg">
            <div>
        ...
        <div>
            <table class="table-striped table-bordered table-hover ">
                ...
                <tr>
                    ...
                    <th class="wd-10p">ISSUE NOTE #</th>
                    <th class="wd-10p">ISSUE NOTE DATE</th>
                ...
                sliceP(
                  ...
                  <td>{{tr.location}}</td>
                    <td>{{tr.department}}</td>
                    <td>{{tr.remarks}}</td>
                 <td>{{parseInt(tr.gross)}}</td>
                    <!--   <td>{{parseInt(tr.discount)}}</td>
                    <td>{{parseInt(tr.tax)}}</td>
                    <td>{{parseInt(tr.grand_total)}}</td>-->

                    <template v-if="tr.approved==0">
                        <td> <a style="color:white;" :href="'/store-management/store-issue-note/approve/' + tr.id"> <button type="button" class="btn btn-sm btn-outline-danger active">Unapproved</button></a></td>
                    </template>
                    <template v-else>
                        <td> <a style="color:white;" :href="'/store-management/store-issue-note/unapprove/' + tr.id"> <button type="button" class="btn btn-sm btn-outline-success active">Approved</button></a></td>
                    </template>


                    <td>{{tr.cashiername}}</td>
<!--  <td class="hidden-print"><button class="buttoncolor" title="Print Note"><a style="color:#000000;" target="_blank" :href="'/store-management/store-issue-note/store-issue-note-invoice/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td> -->
                    <td class="hidden-print"><button class="buttoncolor" title="Print Note"><a style="color:#000000;" target="_blank" :href="'/store-management/store-issue-note/store-issue-note-print/' + tr.id"><i class="fa fa-print" aria-hidden="true"></i></a></button></td>

                    <template v-if="tr.approved==0">
                        <td class="hidden-print"><button class="buttoncolor" title="Edit"><a style="color:#000000;" target="_blank" :href="'/store-management/store-issue-note/store-issue-note-aeu/' + tr.id"><i class="fas fa-edit"></i></a></button></td>
                    </template>
                    <template v-else>
                        <td></td>
                    </template>
    ...
    export default {
        ...
        methods:{
            ...
            afterdel:function(){
                ...
                let url='/store-management/store-issue-note/delete/'+this.deletethisid;
            ...
            init:function () {
                ...
                this.$http.get('/store-management/store-issue-note/issue_note_init_vue').then(result=>{
                    let data=result.data;
                    this.ccs=data.ccs;
                    this.sales=data.sales;
                    this.salesR=data.sales;
                    this.leng=data.sales.length;
                    this.loc_permission=data.locspermit;
