...
class CreateMemProfessionaffiliationsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('mem_professionaffiliations', function (Blueprint $table) {
...
$table->enum('bussiness', ['Businessman', 'Government Officer', 'Armed Forces Officer', 'Private Employee'])->default('Businessman')->nullable();
    ...
    {
        Schema::dropIfExists('mem_professionaffiliations');
    }
}
