...
use Userstamps;
   ...
   /* public function updatepp(){
    ...
    public function  family(){
        return $this->hasMany('App\mem_family','member_id');
    }
    ...
    public function transactions(){
        return $this->hasMany('App\transactions','trans_moc')->where('trans_moc_type',0);
    }
 ...
 public function profilePic(){
        return $this->hasOne('App\media','trans_type_id')->where('trans_type',3);
    }
     public function docs(){
        return $this->hasMany('App\media','trans_type_id')->where('trans_type',90);
    }
}
